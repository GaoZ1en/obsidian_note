...
1. **引力波源**：振荡的宇宙弦环和弦交叉事件可产生特征性引力波信号，这些信号与其他天体源（如黑洞合并）产生的信号具有不同特征。
1. **结构形成**：虽然现代观测表明宇宙弦不是大尺度结构形成的主导因素，但它们仍可能对特定区域的物质密度分布产生影响。
...
1. Planck Collaboration (2013). "Planck 2013 results. XXV. Searches for cosmic strings and other topological defects." Astron. Astrophys., 571, A25.
1. Parkes Pulsar Timing Array (2018). "The NANOGrav 11-year Data Set: New Constraints on the Stochastic Gravitational-wave Background." Astrophys. J., 859(1), 47.
1. Hindmarsh, M. et al. (2017). "Scaling from gauge and scalar radiation in Abelian Higgs string networks." Phys. Rev. D, 96, 023525.
1. Vilenkin, A. & Shellard, E.P.S. (2000). "Cosmic Strings and Other Topological Defects." Cambridge University Press.
