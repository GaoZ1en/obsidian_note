...
1. Trace and diffeomorphism anomalies of the classical Liouville theory, Virasoro algebras, Weyl-gauging and all that. P. Haman and A. Iorio
...
the Lagrangian changes by a total derivative term under the transformation
...
I think we need extra terms containing $\displaystyle{R}$...? i think it is the same as $\mathrm{AdS}_{3}$ gravity...
