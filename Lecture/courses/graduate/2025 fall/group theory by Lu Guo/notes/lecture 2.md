...
1. $\displaystyle{\forall \vec{a},\vec{b}\in V,\vec{a}+\vec{b}=\vec{b}+\vec{a}}$
1. $\displaystyle{\exists\vec{0}\in V,\forall \vec{a}\in V, \vec{a}+\vec{0}=\vec{a}}$
1. $\displaystyle{\forall \vec{a}\in V, \exists-\vec{a}\in V,\vec{a}+(-\vec{a})=\vec{0}}$
1. $\displaystyle{\forall a,b\in F,\forall \vec{a}\in V,a(b\vec{a})=(ab)\vec{a}}$
1. $\displaystyle{\forall \vec{a}\in V,1\vec{a}=\vec{a}}$
1. $\displaystyle{\forall a\in F,\forall \vec{a},\vec{b}\in V,a(\vec{a}+\vec{b})=a\vec{a}+a\vec{b}}$
1. $\displaystyle{\forall a,b\in F,\forall \vec{a}\in V,(a+b)\vec{a}=a\vec{a}+b\vec{a}}$
...
1. $\displaystyle{\forall \vec{a},\vec{b}\in V,\forall \lambda \in F,\langle \vec{a},\lambda \vec{b}\rangle=\lambda \langle \vec{a},\vec{b}\rangle}$
1. $\displaystyle{\forall \vec{a},\vec{b}\in V,\langle \vec{a},\vec{b}\rangle=\overline{\langle \vec{b},\vec{a}\rangle}}$
1. $\displaystyle{\forall \vec{a}\in V,\langle \vec{a},\vec{a}\rangle \geq 0}$ and $\displaystyle{\langle \vec{a},\vec{a}\rangle =0\iff \vec{a}=\vec{0}}$
