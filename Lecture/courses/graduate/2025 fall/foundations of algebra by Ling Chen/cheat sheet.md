...
1. if $\displaystyle{H_{1},H_{2}\leqslant G}$, then $\displaystyle{H_{1}\cup H_{2}\leqslant G\iff H_{1}\subseteq H_{2}}$ or $\displaystyle{H_{2}\subseteq H_{1}}$.
...
1. $\displaystyle{H_{1},H_{2}\leqslant G}$ then $\displaystyle{H_{1}H_{2}\leqslant G\iff H_{1}H_{2}=H_{2}H_{1}}$
...
1. if $\displaystyle{A\leqslant B\leqslant G}$, then $\displaystyle{[G:A]=[G:B][B:A]}$
1. $\displaystyle{[G:A\cap B]\leqslant[G:A][G:B]}$. and if $\displaystyle{[G:A]}$ coprime to $\displaystyle{[G:B]}$, the equality holds and $\displaystyle{AB=G}$
...
1. for a single element subset $\displaystyle{M=\{a\}}$, we have $\displaystyle{C_{G}(a)=\left\{g\in G|g^{-1}ag=a\right\}}$.
...
1. Second (Diamond) Isomorphism Theorem
...
1. Correspondence Theorem (Lattice Isomorphism)
...
1. Universal Property of Quotient Groups
...
1. Special Ideals: Prime vs Maximal
...
1. Structure Theorem for Finitely Generated Modules over a PID
...
\end{align}$$
    ...
    1. calculate the number of elements in $\displaystyle{\left\{\tau \in S_{6}|\tau(2)=5\right\}}$
...
1. suppose $\displaystyle{\sigma \in A_{n}}$, $\displaystyle{K_{\sigma}}$ is the set of all pertumations in $\displaystyle{A_{n}}$ that have the same cycle type as $\displaystyle{\sigma}$. $\displaystyle{C_{S_{n}}(\sigma)}$ is the centralizer of $\displaystyle{\sigma}$ in $\displaystyle{S_{n}}$, prove that
    ...
    1. if all elements in $\displaystyle{C_{S_{n}}(\sigma)}$ are even, then $\displaystyle{K_{\sigma}}$ is the union of two distinct conjugacy classes in $\displaystyle{A_{n}}$.
...
1. if all elements in $\displaystyle{C_{S_{n}}(\sigma)}$ are even, then $\displaystyle{C_{S_{n}}(\sigma)\subseteq A_{n}}$. thus
...
1. suppose $\displaystyle{\sigma=(12\dots n)}$ is a total cycle in $\displaystyle{S_{n}}$. prove that $\displaystyle{C_{S_{n}}(\sigma)= \braket{ \sigma }}$.
...
1. determine all the normal subgroups of $\displaystyle{S_{4}}$.
...
1. if $\displaystyle{|N|=2}$, then $\displaystyle{N}$ must contain an element of order 2. since the conjugacy class of any transposition has size 6, thus $\displaystyle{N}$ can only contain $\displaystyle{(12)(34)}$. thus $\displaystyle{N=\left\{e,(12)(34)\right\}}$.
1. if $\displaystyle{|N|=3}$, then $\displaystyle{N}$ is cyclic group generated by an element of order 3. since the conjugacy class of any 3-cycle has size 8, contradiction.
1. if $\displaystyle{|N|=4}$, then $\displaystyle{N}$ is isomorphic to either $\displaystyle{C_{4}}$ or $\displaystyle{C_{2}\times C_{2}}$. since the conjugacy class of any element with order 4 has size 6, thus $\displaystyle{N}$ must be isomorphic to $\displaystyle{C_{2}\times C_{2}}$. thus $\displaystyle{N=\left\{e,(12)(34),(13)(24),(14)(23)\right\}}$.
1. if $\displaystyle{|N|=6}$, then $\displaystyle{N}$ is isomorphic to $\displaystyle{S_{3}}$ or $\displaystyle{C_{6}}$. since the conjugacy class of any 3-cycle has size 8, and the conjugacy class of any transposition has size 6, contradiction.
1. if $\displaystyle{|N|=8}$, then $\displaystyle{N}$ is isomorphic to $\displaystyle{D_{8}}$ or $\displaystyle{C_{8}}$ or $\displaystyle{Q_{8}}$. since the conjugacy class of any element with order 4 has size 6, contradiction.
1. if $\displaystyle{|N|=12}$, then $\displaystyle{N}$ must contain an element from each conjugacy class with size greater than 1. thus $\displaystyle{N}$ contains at least $\displaystyle{1+6+8=15}$ elements, contradiction.
1. if $\displaystyle{|N|=24}$, then $\displaystyle{N=S_{4}}$. trivial.
...
1. $\displaystyle{\forall aH, \rho _{H}(g)(g^{-1}aH)=aH}$, $\displaystyle{\rho _{H}(g)}$ is surjective
1. $\displaystyle{\forall g_{1},g_{2}\in G, \rho _{H}(g_{1}g_{2})(aH)=g_{1}g_{2}aH=\rho _{H}(g_{1})(\rho _{H}(g_{2})(aH))}$, $\displaystyle{\rho _{H}}$ is a homomorphism. thus $\displaystyle{G\cong \rho _{H}(G)\leqslant S_{X}}$.
...
1. $\displaystyle{\forall aAa^{-1}, \pi(g)(g^{-1}aAa^{-1}g)=aAa^{-1}}$, $\displaystyle{\pi(g)}$ is surjective
1. $\displaystyle{\forall g_{1},g_{2}\in G, \pi(g_{1}g_{2})(aAa^{-1})=g_{1}g_{2}aAa^{-1}g_{2}^{-1}g_{1}^{-1}=\pi(g_{1})(\pi(g_{2})(aAa^{-1}))}$, $\displaystyle{\pi}$ is a homomorphism.
...
1. all Sylow $\displaystyle{p}$-subgroups are conjugate to each other
1. the number of Sylow $\displaystyle{p}$-subgroups $\displaystyle{N(p^{r})}$ satisfies $\displaystyle{N(p^{r})\equiv 1\mod{p}}$ and $\displaystyle{N(p^{r})|n}$, where $\displaystyle{|G|=np^{r},p\nmid n}$.
1. the number of Sylow $\displaystyle{p}$-subgroups is $\displaystyle{[G:N_{G}(P)]}$
...
1. suppose $\displaystyle{P}$ is a Sylow $\displaystyle{p}$-subgroup of $\displaystyle{G}$, $\displaystyle{A\leqslant G}$, and $\displaystyle{N_{G}(P)\leqslant A}$, then $\displaystyle{N_{G}(A)=A}$
proof. we have
...
1. $\displaystyle{M\triangleleft G}$, $\displaystyle{P}$ is a Sylow $\displaystyle{p}$-subgroup of $\displaystyle{M}$, then $\displaystyle{G=MN_{G}(P)}$
...
1.  **Embeddings into Symmetric Groups (Index Factorial)**
...
1.  **Groups of Order $pq$** (Detailed classification)
...
1.  **Simple Group Tests (Index Factorial / $n!$ Theorem)**
...
1. if $\displaystyle{a\in U(R)}$, then $\displaystyle{f(a)\in U(s)}$, and $\displaystyle{f(a^{-1})=f(a^{-1})}$
...
1. $\displaystyle{I_{1}+I_{2}}$ is also an ideal of $\displaystyle{R}$, and it is the smallest ideal containing both $\displaystyle{I_{1}}$ and $\displaystyle{I_{2}}$.
proof. we only need to check $\displaystyle{\forall a_{1},a_{2}\in I_{1},b_{1},b_{2}\in I_{2}, (a_{1}+b_{1})-(a_{2}+b_{2})\in I_{1}+I_{2}, (a_{1}+b_{1})(a_{2}+b_{2})\in I_{1}+I_{2}}$. indeed, we have
...
1. prove that $\displaystyle{\bar{f}:R /I\to S /J}$ is a ring isomorphism iff $\displaystyle{f(R)+J=S}$ and $\displaystyle{I=f^{-1}(J)}$
...
1. $\displaystyle{\forall a,b\in R, ab\in P\implies a\in P\text{ or }b\in P}$
1. $\displaystyle{R/P}$ is an integral domain
...
1. if $\displaystyle{Q}$ is a prime ideal of $\displaystyle{S}$, then $\displaystyle{f^{-1}(Q)}$ is a prime ideal of $\displaystyle{R}$ containing $K$.
...
1. prime ideals of $\displaystyle{S}$ and prime ideals of $\displaystyle{R}$ containing $\displaystyle{K}$ are in one-to-one correspondence.
...
1. Since $(a,b)=1$, in their prime factorizations, they share no common prime factors (meaning $\min(\alpha_p, \beta_p) = 0$ for all $p$).
...
1. $\displaystyle{a=\sqrt{2}+\sqrt{3}}$, $\displaystyle{K=\mathbb{Q}(\sqrt{2})}$
...
1. $\displaystyle{a=\sqrt{2}+\sqrt{3}}$, $\displaystyle{K=\mathbb{Q}(\sqrt{3})}$
...
1. try to represent $\displaystyle{u^{4},(u+1)^{-1},(u^{2}-6+8)^{-1}}$ as a $\displaystyle{\mathbb{Q}}-$linear combination of $\displaystyle{1,u,u^{2}}$.
