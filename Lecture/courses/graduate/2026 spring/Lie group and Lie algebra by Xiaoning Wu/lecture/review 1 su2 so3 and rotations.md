...
1. To decompose a tensor product, use the Clebsch-Gordan interval.
1. To find the weights, start from the highest weight and subtract the simple root.
1. To identify the adjoint representation, use spin $1$, dimension $3$.
