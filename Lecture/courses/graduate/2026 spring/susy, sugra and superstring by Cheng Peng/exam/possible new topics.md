...
2. How are external string states inserted into the worldsheet theory?
3. How do boundary conditions and dualities acquire geometric meaning?
4. How does one go beyond flat ten-dimensional Minkowski space?
5. How does one-loop consistency unify the Hilbert-space construction?
...
2. Show that nilpotency of $Q_{\mathrm{BRST}}$ requires vanishing total conformal anomaly.
3. Explain why
...
4. Compare BRST physical states with Gupta-Bleuler or light-cone physical states.
...
2. Derive the on-shell condition and transversality condition from the worldsheet requirement that the integrated vertex operator be marginal.
3. Compare open-string and closed-string vertex operators.
4. Compute a simple two-point or three-point correlator using free-field OPEs.
...
2. Show that the closed-string spectrum is invariant under
...
3. Show that for open strings, T-duality exchanges Neumann and Dirichlet boundary conditions.
4. Explain how a D-brane emerges from the dualized boundary condition.
...
2. Derive the modified mass formula with discrete momentum and winding.
3. Explain level matching in the presence of winding.
4. For an orbifold, explain qualitatively what twisted sectors are and why they must be included.
...
2. Show how the $T$ transformation encodes level matching or integrality conditions.
3. Explain why a single spin structure is not modular invariant.
4. Explain why the heterotic internal lattice must be even and self-dual.
...
2. Show that a superspace action reproduces the component RNS action.
3. Integrate out the auxiliary field and recover the on-shell action.
4. Show how worldsheet supersymmetry becomes manifest in superspace notation.
...
2. Derive the current conservation equations.
3. Write the energy-momentum tensor in terms of currents.
4. Explain how a curved target space can still give an exactly solvable worldsheet CFT.
...
1. BRST quantization
2. Vertex operators and simple amplitudes
3. One-loop partition function and modular invariance
...
2. Compactification and simple orbifolds
...
2. WZW models and strings in curved backgrounds
...
3. One-loop partition function and modular invariance
4. T-duality and D-branes
5. Worldsheet superspace and superfield formulation
6. Compactification and simple orbifolds
7. WZW models and strings in curved backgrounds
