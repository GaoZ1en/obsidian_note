...
5. suppose $\displaystyle{A,B}$ are two subgroup of $\displaystyle{G}$. prove $\displaystyle{A\cup B}$ is a subgroup iff $\displaystyle{A\leqslant B}$ or $\displaystyle{B\leqslant A}$. 
*sol*.