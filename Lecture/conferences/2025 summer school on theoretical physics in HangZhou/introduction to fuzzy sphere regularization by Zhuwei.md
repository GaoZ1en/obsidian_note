...
1. Landau level on the sphere geometry $\displaystyle{S^{2}\times \mathbb{R}}$
1. example: 3D ising transition (scaling dimension, OPE, CFT data...)
1. more applications
