...
1. difficult diagrams in curved spacetime
...
1. $\displaystyle{K_{\mu}}$, special conformal transformation
	1. $\displaystyle{K_{\mu}=i(2x_{\mu}x^{\nu}\partial _{\nu}-x^{2}\partial _{\mu})}$
1. $\displaystyle{D}$, dilatation
...
1. super charge $\displaystyle{\mathcal{Q}}$, and superconformal charge $\displaystyle{\mathcal{S}}$,
1. $\displaystyle{R}$ symmetry, $\displaystyle{SO(6)}$, $\displaystyle{S^{5}}$ isometry
...
1. infinitely many particles
1. complicated vertices
1. proliferation of diagrams
...
1. Bose symmetry
1. analytic property. $\displaystyle{\mathcal{M}}$ has simple pole with polynomial residues.
1. asymptotic behavior of $\displaystyle{\mathcal{M}}$. $\displaystyle{\lim_{ \beta \to \infty }\mathcal{M}(\beta s,\beta t)}$ grows linearly, comes from scattering amplitude in flat spacetime.
...
1. ...
1. ...
1. generalization to defect CFT
