...
1. Matrix bootstrap and some examples
	1. integral
	1. matrix model
1. LQCD
	1. loop equation
...
1. Seiberg-Witten
1. low dimension model: 2D 't Hooft model
1. planar $\displaystyle{\mathcal{N}=4}$ SYM (AdS/CFT, integrability, Yangian symmetry, ...)
1. conformal bootstrap
1. S-matrix bootstrap
1. matrix bootstrap
1. lqcd (MC simulation)
...
1. non perturbative
1. use Lagrangian
1. not require specific symmetry (such as susy...)
1. for general spacetime dimension (especially for $d=2$)
...
1. loop equation (dynamics)
1. positivity
	1. hermitian
	1. reflection positivity (unitarity)
...
1. lattice symmetry
1. inverse symmetry $\displaystyle{\braket{ W }= \braket{ W^{\dagger} }}$.

Schwinger-Dyson equation is exactly the quantum generalization of Euler-Lagrange equation?!
