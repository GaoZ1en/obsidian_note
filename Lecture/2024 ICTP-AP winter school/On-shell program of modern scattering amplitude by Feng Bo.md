S-Matrix program. twistor string
...
where $\displaystyle{\lambda_{\alpha},\tilde{\lambda}_{\dot{\alpha}}}$ are 2-component spinors, and also wave functions of massless 1/2-spin particle.
...
see 1612.02797, 1612.03885, 1612.06342, 1807.09738 for more info.
...
BCJ relation, come from string theory
...
propagators generate the ideal $\displaystyle{I}$ of polynomial ring $\displaystyle{k[x_{1},x_{2},x_{3},x_{4}]}$
