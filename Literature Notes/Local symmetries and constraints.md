...
authors: Joohan Lee and Robert M. Wald
...
$\displaystyle{\mathcal{F}}$, the manifold of field configuration in the common sense. the local symmetry group of $\displaystyle{\mathcal{F}}$ is denoted as $\displaystyle{\mathcal{G}}$.

$$\begin{align}
S[\phi] & =\int _{M}\mathrm{d}^{d}x\sqrt{ -g }\mathcal{L}[\phi] \\
\mathcal{L}[\phi] & =\mathcal{L}(\phi ^{a},\nabla _{\mu}\phi ^{a},\dots,\nabla _{(\mu_{1}}\dots \nabla _{\mu _{k})}\phi ^{a};\gamma ^{b})
\end{align}$$

where $\displaystyle{\phi ^{a}}$'s are dynamical fields, and $\displaystyle{\gamma ^{b}}$'s are non-dynamical background field