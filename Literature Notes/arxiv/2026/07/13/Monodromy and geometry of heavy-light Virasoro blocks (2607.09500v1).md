...
$$
\epsilon_i=\frac{6\Delta_i}{c},
\qquad
\widetilde\epsilon_i=\frac{6\widetilde\Delta_i}{c},
\qquad
\mathfrak F\sim\exp\!\left(\frac{c}{6}f\right).
$$
...
$$
\lambda_\pm^{(k-1)}
=e^{i\pi(1\pm\sqrt{1-4\widetilde\epsilon_{k-1}})}.
$$
...
M_{\gamma_i}
=\operatorname{Id}
+2\pi i\epsilon_iP_i\Lambda P_i^{-1}
+O(c^{-2}),
\qquad
\Lambda=\operatorname{diag}(1,-1),
\tag{2.5}
$$
...
$$
T^{(0)}=\frac{\epsilon_h}{z^2},
\qquad
\alpha=\sqrt{1-\frac{24\Delta_h}{c}},
\qquad
\mathfrak w=z^\alpha.
$$
...
$$
M_{\gamma_{z_1}}M_{\gamma_{z_2}}M_{\gamma_{z_3}}
=\operatorname{Id}.
\tag{2.8}
$$
...
$$
\sum_{i=1}^3\epsilon_iP_i\Lambda P_i^{-1}=0.
\tag{2.9}
$$
...
$$
\sum_i\epsilon_i
\frac{\mathfrak w_i+\widehat{\mathfrak w}_i}
{\mathfrak w_i-\widehat{\mathfrak w}_i}=0,
$$

$$
\sum_i\epsilon_i
\frac{1}{\mathfrak w_i-\widehat{\mathfrak w}_i}=0,
\qquad
\sum_i\epsilon_i
\frac{\mathfrak w_i\widehat{\mathfrak w}_i}
{\mathfrak w_i-\widehat{\mathfrak w}_i}=0.
...
\widetilde{\mathfrak w}_{12},\widetilde{\mathfrak w}_{11})
=-
\frac{-\epsilon_1+\epsilon_2+\widetilde\epsilon_1}
{\epsilon_1-\epsilon_2+\widetilde\epsilon_1}.
\tag{3.11}
$$
...
$$
\widetilde{\mathfrak w}_{11}
+\widetilde{\mathfrak w}_{12}=0.
\tag{4.2}
$$
...
\widetilde{\mathfrak w}_{11}
=\frac{
\beta(\mathfrak w_1-\mathfrak w_2)
-\sqrt{\beta^2(\mathfrak w_1-\mathfrak w_2)^2
+4\mathfrak w_1\mathfrak w_2}
}{2},
\qquad
\beta=\frac{\epsilon_2-\epsilon_1}{\widetilde\epsilon_1}.
\tag{4.3}
$$
...
$$
P(x)=
[\zeta+(b-\zeta u)x+ax^2]
[\zeta+(d-\zeta u)x+cx^2]
+\eta^2(1-ux)^2=0,
\tag{4.8}
$$
...
$$
u=\frac{2\widetilde\epsilon_1}
{\epsilon_1-\epsilon_2+\widetilde\epsilon_1},
\qquad
a=\frac{\widetilde\epsilon_1-\epsilon_3+\widetilde\epsilon_2}
{\epsilon_1-\epsilon_2+\widetilde\epsilon_1},
$$

$$
b=\frac{-\epsilon_1+\epsilon_2+\epsilon_3-\widetilde\epsilon_2}
{\epsilon_1-\epsilon_2+\widetilde\epsilon_1},
\qquad
c=\frac{\widetilde\epsilon_1-\epsilon_3-\widetilde\epsilon_2}
{\epsilon_1-\epsilon_2+\widetilde\epsilon_1},
$$

$$
d=\frac{-\epsilon_1+\epsilon_2+\epsilon_3+\widetilde\epsilon_2}
{\epsilon_1-\epsilon_2+\widetilde\epsilon_1}.
\tag{4.9}
$$
...
\epsilon_3\to0,
\qquad
\widetilde\epsilon_1=\widetilde\epsilon_2,
$$
