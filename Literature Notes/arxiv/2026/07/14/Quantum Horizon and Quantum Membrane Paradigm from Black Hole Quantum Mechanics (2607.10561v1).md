...
\text{matrix blocks}
\longrightarrow
\text{Berry-monopole LLL partons}
\longrightarrow
\text{Hall/longitudinal response}
\longrightarrow
\text{link condensation}
\longrightarrow
b_A\simeq a_A|_{r=R}
\longrightarrow
\text{Maxwell boundary admittance}.
$$
...
$$
\begin{aligned}
&\text{matrix action and two-block expansion}
\xrightarrow{\text{Secs. 3 and 5}}
(b_A,a_A,W_A,\text{Gauss law})\\
&\text{fuzzy spin frame and Berry line bundle}
\xrightarrow{\text{Secs. 4.2--4.4}}
(\mathcal F,\text{LLL},\{\cdot,\cdot\}_{\rm GC})\\
&\text{guiding-center response and thermal friction}
\xrightarrow{\text{Sec. 4.5}}
(\sigma_H,\sigma_{xx})\\
&\text{outward-extremal link instability}
\xrightarrow{\text{Sec. 6.1}}
\langle W_A\rangle\neq0
\xrightarrow{\text{Sec. 6.2}}
b_A-a_A=O(\mathscr K^{-1})\\
&\hspace{7em}\xrightarrow{\text{Maxwell variation}}
F_A{}^n=4\pi j_A^{\rm tot}
\xrightarrow{\text{Sec. 6.3}}
\mathcal R_\pm(\omega).
\end{aligned}
$$
...
$$
S=\int dt\,\operatorname{Tr}\!\left[
\frac{1}{2a_0^2M_P}\dot X_a^2
+\frac{M_P}{N^2}\bigl([X_a,X_b]^2+4X_a^2\bigr)
+i\psi^\dagger\dot\psi
-a_2\frac{M_P}{N^2}\psi^\dagger\sigma_aX_a\psi
\right].
\tag{1.1}
$$
...
$$
j_A^{\rm mem}=\frac{1}{4\pi}F_{A\mu}n^\mu.
\tag{2.3}
$$
...
$$
j_A^{\rm mem}=\frac{1}{4\pi}E_A,
\qquad
E_A=F_{A\tau}=\frac{F_{At}}{\sqrt f},
\qquad
f(r)=1-\frac{R}{r}.
\tag{2.5--2.6}
$$
...
$$
f\,\partial_rA_A=\partial_tA_A,
\qquad
(\partial_t-\partial_{r_*})A_A=0,
\qquad
dr_*=\frac{dr}{f}.
\tag{2.9--2.10}
$$
...
$$
\mathcal N=(S\!\cdot\!L)^2-(S\!\cdot\!L)-2,
\qquad
(S_c)_{ab}=-i\epsilon_{cab},
$$
...
$$
S_H=\frac{R^2}{2g_{\rm BH}^2}\int d\tau\,d\Omega\left[
(\partial_\tau b_A)^2+(\partial_\tau\phi_H)^2
-\frac{1}{l_P^2}\left(
f^2+(D_A\phi_H)^2+4\phi_H^2-8f\phi_H
\right)
\right],
\tag{3.18}
$$
...
$$
\frac{1}{2g_{\rm BH}^2}=\frac{l_P}{4\pi a_0}.
\tag{3.19}
$$
...
$$
\Theta_H
=\frac{R^2}{g_{\rm BH}^2}\int_{S^2}d\Omega\,
\left(\partial_\tau b^A\,\delta b_A
+\partial_\tau\phi_H\,\delta\phi_H\right).
$$
...
X_a=LY_a,
\qquad
Y_a=y_a+\frac{R}{L}A_a,
\qquad
y_a=\frac{x_a}{2l_PL}-i\partial_a.
\tag{3.20--3.23}
$$
...
L=\frac{N'l_P}{N},
\qquad
\operatorname{Tr}_{N'}f=\frac{N'}{V_3}\int d^3x\,f,
\qquad
V_3=\nu_3R^2L,
$$
...
$$
S_{\rm env}
=\frac{1}{2g_{\rm EM}^2}\int d\tau\,d^3x
\left[(\partial_\tau A_a)^2-\frac12F_{ab}F_{ab}\right],
\qquad
\frac{1}{2g_{\rm EM}^2}=\frac{1}{a_0\nu_3}.
\tag{3.28}
$$
...
$$
A_a|_{r=R}=K_a{}^Aa_A+n_a\phi_E,
\qquad
\delta a_A=D_A\lambda,
\qquad
\delta\phi_E=0.
\tag{3.31--3.33}
$$
...
$$
H_F=\frac{a_2M_P}{2N}(r+s),
\qquad
r=\sum_{p,k}u_k^{p\dagger}u_k^p,
\qquad
s=\sum_{p,k}d_k^{p\dagger}d_k^p.
\tag{4.4--4.5}
$$
...
$$
\mathcal A=-i\langle\Omega|d|\Omega\rangle
=J(1-\cos\theta)d\phi,
\tag{4.16}
$$
...
\qquad
\frac{1}{2\pi}\int_{S^2}\mathcal F=2J=N-1.
\tag{C.3--C.4}
$$
...
$$
(\sigma\!\cdot\!n)\eta_\pm=\pm\eta_\pm,
\qquad
\chi_I=\eta_+u_I+\eta_-d_I^\dagger.
\tag{4.33, 4.37}
$$
...
$$
S_F=\int d\tau\,d\Sigma\left[
\sum_I\left(iu_I^\dagger\partial_\tau u_I
+id_I^\dagger\partial_\tau d_I\right)
-j_Ab^A-n_P\mu
\right],
\tag{4.40}
$$
...
$$
n_P=\sum_I(u_I^\dagger u_I+d_I^\dagger d_I),
\qquad
\rho=q\sum_I(u_I^\dagger u_I-d_I^\dagger d_I),
$$
...
$$
L_K=\sum_{p\in\mathcal S}\left[
i\eta_p^\dagger\dot\eta_p
\pm\mathcal A_A(\Omega_p)\dot\xi_p^A
\right],
\tag{4.51}
$$
...
$$
\Theta_{\rm parton}
=\sum_p\left[i\eta_p^\dagger\delta\eta_p
+\pm\mathcal A_A\delta\xi_p^A\right],
$$

$$
\Omega_{\rm parton}
=\sum_p\left[
i\,\delta\eta_p^\dagger\wedge\delta\eta_p
+\pm\frac12\mathcal F_{AB}
\delta\xi_p^A\wedge\delta\xi_p^B
\right].
$$
...
$$
(\mathcal F_{AB}-qF_{AB})\dot y^B=-qE_A,
\qquad
E_A=-\partial_\tau b_A.
\tag{4.55}
$$
...
$$
\mathcal F_s\epsilon_{AB}v_s^B
=-q_sE_A+\eta v_{sA},
\qquad
q_s=\pm q,
\qquad
\mathcal F_s=\pm\mathcal F.
\tag{4.64}
$$
...
$$
v_s^A
=\frac{q_s}{\eta^2+\mathcal F^2}
\left(\eta\delta^{AB}+\mathcal F_s\epsilon^{AB}\right)E_B.
\tag{4.65}
$$
...
$$
\operatorname{Tr}_H\rho_W^H
=-\operatorname{Tr}_E\rho_W^E,
\tag{5.64}
$$
...
$$
D^AE_A^H=\rho_\psi^H+\rho_W^H,
\qquad
\nabla_iE^i=\rho_W^E+\rho_\psi^E.
\tag{5.65, 5.67}
$$
...
$$
\mathcal K_{ab}(\xi)
=\mathcal H_{ab}(\xi)-4\delta_{ab}-4(\mathbf J\!\cdot\!\mathbf S)_{ab},
$$

$$
\mathcal H_{ab}=2(\bar{\mathcal D}^2\delta_{ab}-\bar{\mathcal D}_b\bar{\mathcal D}_a),
\qquad
\bar{\mathcal D}_aW_b=(J_a-\xi_a)W_b.
\tag{6.20--6.22}
$$
...
$$
W_a=w\,e_a^{(+)}|J,J\rangle_H\,{}_E\langle\xi,\hat z|,
\tag{6.34}
$$
...
$$
V_{\rm int}
=\frac{\mathscr K}{2}\int d\Omega\left[
(b_A-a_A)^2+2(\phi_H-\phi_E)^2
\right],
$$

$$
\mathscr K=\frac{N^3l_P}{8\pi a_0}.
\tag{6.53--6.54}
$$
...
$$
\frac{1}{4\pi}F_B{}^n
+\frac{\mathscr K}{R^2}(b_B-a_B)=0,
\tag{6.57}
$$

$$
\frac{1}{g_{\rm BH}^2}
(\Box b_B-\partial_B\partial_Ab_A)
-j_B
-\frac{\mathscr K}{R^2}(b_B-a_B)=0.
\tag{6.58}
$$
...
$$
F_B{}^n=4\pi j_B^{\rm tot},
\qquad
j_B^{\rm tot}=\sigma_{BC}(\omega)E^C,
\tag{6.64}
$$
...
$$
\partial_{r_*}a_A-4\pi\sigma_{AB}\partial_ta_B=0.
\tag{6.69}
$$
...
$$
e_A^{(\pm)}=\frac{1}{\sqrt2}(e_A^1\pm ie_A^2),
\qquad
\epsilon_A{}^Be_B^{(\pm)}=\pm i e_A^{(\pm)},
$$
...
$$
\partial_ua_A^{(\pm)}
=\mathcal R_\pm\partial_va_A^{(\pm)},
$$

$$
\mathcal R_\pm
=-\frac{i\mathcal D_\pm}{1+i\mathcal D_\pm},
\qquad
...
$$
\eta_{\rm ellp}
=\frac12\log\left|\frac{\mathcal R_+}{\mathcal R_-}\right|
\simeq\frac{\sigma_H}{\omega D}.
\tag{6.78--6.79}
$$
...
- Mathematica inverted the Langevin operator and reproduced Eq. (4.65). With $J=N/2$, $N_s=N^2\nu_s$, and $\gamma_T=\eta/\mathcal F$, it reproduced the longitudinal and Hall coefficients and the expansion
  ...
  $$
  \sigma_{xx}=\frac{q^2c_T}{2\pi}
  -\frac{q^2c_T^3}{2\pi N^2}+O(N^{-4}).
  $$
...
- Mathematica converted the Robin boundary condition into
  ...
  $$
  \theta_{\rm rot}
  =-\frac{2\pi\sigma_H}{1+4\pi^2\omega^2D^2}+O(\sigma_H^2),
  $$

  $$
  \eta_{\rm ellp}
  =\frac{\sigma_H}{\omega D(1+4\pi^2\omega^2D^2)}
  +O(\sigma_H^2),
  $$
...
- Equation (6.38), visible on PDF page 35, prints
  ...
  $$
  e_a^{(+)}e_b^{(+)*}
  =\frac12\left(P^T_{ab}+i\epsilon_{abc}n_c\right)
  $$
