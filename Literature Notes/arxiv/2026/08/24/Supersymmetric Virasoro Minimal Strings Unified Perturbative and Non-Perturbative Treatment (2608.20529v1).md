...
$$\begin{align}
u\mathcal R^2 -\frac{\hbar^2}{2}\mathcal R\mathcal R'' +\frac{\hbar^2}{4}(\mathcal R')^2 =\hbar^2\Gamma^2,
\end{align}$$
...
$$\begin{align}
R_1=u, \qquad R_2=u^2-\frac{\hbar^2}{3}u'',
\end{align}$$

$$\begin{align}
R_3=u^3-\frac{\hbar^2}{2}(u')^2 -\hbar^2uu''+\frac{\hbar^4}{10}u''''.
\end{align}$$

At $\Gamma=0$ and leading genus order,

$$\begin{align}
u_0\mathcal R_0^2=0, \qquad \mathcal R_0=\sum_{k\ge1}t_ku_0^k+x.
\end{align}$$
...
$$\begin{align}
\mathcal R=x, \qquad \mathcal R'=1, \qquad \mathcal R''=0.
\end{align}$$
...
$$\begin{align}
r^2=\frac12 \left(u_{\Gamma=1/2}+u_{\Gamma=-1/2}\right),
\end{align}$$
...
$$\begin{align}
V_{0,4}^{0A^+} =\frac{2c-15}{24}+\sum_{i=1}^4P_i^2,
\end{align}$$

$$\begin{align}
V_{1,1}^{0A^+} =\frac{2c-15}{576}+\frac{P^2}{24}.
\end{align}$$
...
$$\begin{align}
\rho_{0,J}^{N=4\,\mathrm{JT}}(E) =\frac{J}{\pi^2\hbar_{\rm JT}E^2} \sinh\!\left(2\pi\sqrt{E-J^2}\right) \Theta(E-J^2).
\end{align}$$
