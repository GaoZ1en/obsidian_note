...
$$
S_E[A] = \int_0^\beta d\tau \int d^3x \left[
\frac{1}{4} F_{\mu\nu}F_{\mu\nu} + \frac{1}{2} m^2 A_\mu A_\mu
\right]
$$
其中$F_{\mu\nu} = \partial_\mu A_\nu - \partial_\nu A_\mu$。
...
$$
\boxed{
\ln Z = \frac{3}{2} \int_0^\infty \frac{d\tau}{\tau} \frac{1}{(4\pi \tau)^{3/2}} \sum_{n=-\infty}^{\infty} e^{-\tau \left( \left(\frac{2\pi n}{\beta}\right)^2 + m^2 \right)}
}
$$
