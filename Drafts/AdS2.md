...
\qquad \eta \in[0,\infty),\; \phi \in[0,2\pi)
$$
...
$$
\Delta f 
= \frac{1}{\sqrt{g}}\,\partial_i\bigl(\sqrt{g}\,g^{ij}\,\partial_j f\bigr),
$$
...
$$
g^{\eta\eta} = 1,\qquad g^{\phi\phi} = \frac{1}{\sinh^2\eta},\qquad
g = \det(g_{ij}) = 1\cdot \sinh^2\eta = \sinh^2\eta.
$$
...
$$
\Delta f
 = \frac{1}{\sinh\eta}\partial_\eta\bigl(\sinh\eta\,\partial_\eta f\bigr)
	+ \frac{1}{\sinh\eta}\partial_\phi\Bigl(\sinh\eta\,\frac{1}{\sinh^2\eta}\partial_\phi f\Bigr).
$$
...
$$
\frac{1}{\sinh\eta}\partial_\phi\Bigl(\sinh\eta\,\frac{1}{\sinh^2\eta}\partial_\phi f\Bigr)
 = \frac{1}{\sinh\eta}\cdot \sinh\eta\,\partial_\phi\Bigl(\frac{1}{\sinh^2\eta}\partial_\phi f\Bigr)
 = \frac{1}{\sinh^2\eta}\partial_\phi^2 f.
$$
...
$$
\boxed{\displaystyle
\Delta = \partial_\eta^2 + \coth\eta\,\partial_\eta
			+ \frac{1}{\sinh^2\eta}\,\partial_\phi^2 }
$$
...
$$
 -\biggl(\partial_\eta^2 + \coth\eta\,\partial_\eta
			+ \frac{1}{\sinh^2\eta}\,\partial_\phi^2\biggr)\Psi(\eta,\phi)
 = \lambda\,\Psi(\eta,\phi).
$$
...
$$
-\frac{1}{R}\bigl(R'' + \coth\eta\,R'\bigr)
 - \frac{1}{\sinh^2\eta}\frac{1}{Y}Y'' = \lambda.
$$
...
$$
\int_0^{2\pi} \!\mathrm{d}\phi\,Y_m(\phi)Y_{m'}^*(\phi)
 = \delta_{mm'}.
$$
...
$$
 -\bigl(R'' + \coth\eta\,R'\bigr)
 + \frac{m^2}{\sinh^2\eta} R = \lambda R.
$$
...
$$
 -\frac{1}{\sinh\eta}\frac{\mathrm{d}}{\mathrm{d}\eta}
	\bigl(\sinh\eta\,R'\bigr)
	+ \frac{m^2}{\sinh^2\eta}R
 = \lambda R.
$$
...
$$
 -\frac{\mathrm{d}}{\mathrm{d}\eta}\Bigl(\sinh\eta\,\frac{\mathrm{d}R}{\mathrm{d}\eta}\Bigr)
 + \frac{m^2}{\sinh\eta}R
 = \lambda\,\sinh\eta\,R.
$$
...
$$
\sinh^2\eta = z^2-1,\qquad
\frac{\mathrm{d}z}{\mathrm{d}\eta} = \sinh\eta = \sqrt{z^2-1}.
$$

设 $R(\eta) = F(z)$，则

$$
\frac{\mathrm{d}R}{\mathrm{d}\eta} = \frac{\mathrm{d}F}{\mathrm{d}z}\frac{\mathrm{d}z}{\mathrm{d}\eta}
 = \sqrt{z^2-1}\,F'(z),
$$
...
$$
\coth\eta\,R'(\eta)
 = \frac{z}{\sqrt{z^2-1}}\cdot \sqrt{z^2-1}F'(z)
 = z F'(z).
$$
...
$$
 R'' + \coth\eta\,R'
 + \Bigl(\frac{1}{4}+\rho^2 - \frac{m^2}{\sinh^2\eta}\Bigr)R = 0
$$
...
$$
 (z^2-1)F''(z) + 2z F'(z)
 + \Bigl(\frac{1}{4}+\rho^2 - \frac{m^2}{z^2-1}\Bigr)F(z) = 0.
$$
...
$$
 (1-z^2)F''(z) - 2z F'(z)
 + \Bigl(-\frac{1}{4}-\rho^2 - \frac{m^2}{1-z^2}\Bigr)F(z) = 0.
$$
...
$$
\nu(\nu+1) = \Bigl(-\frac{1}{2}+i\rho\Bigr)\Bigl(\frac{1}{2}+i\rho\Bigr)
 = -\frac{1}{4} - \rho^2.
$$
...
$$
F(z) = A\,P_{-\frac{1}{2}+i\rho}^{m}(z)
	  + B\,P_{-\frac{1}{2}+i\rho}^{-m}(z),\qquad z=\cosh\eta\ge 1.
$$
...
\boxed{\displaystyle
\Psi_{\rho m}(\eta,\phi)
 = N_{\rho m}\,P_{-\frac{1}{2}+i\rho}^{|m|}(\cosh\eta)\,\frac{e^{i m \phi}}{\sqrt{2\pi}},
\quad \rho\ge 0,\; m\in\mathbb{Z},}
$$
...
$$
L^2(H_2,\mathrm{d}\mu),\qquad
\mathrm{d}\mu = \sinh\eta\,\mathrm{d}\eta\,\mathrm{d}\phi.
$$
...
\langle \Phi,\Psi\rangle
 = \int_0^{2\pi}\!\mathrm{d}\phi
	\int_0^{\infty}\!\mathrm{d}\eta\,\sinh\eta\,\Phi^*(\eta,\phi)\Psi(\eta,\phi).
$$
...
$$
\Psi_{\rho m}(\eta,\phi)
 = N_{\rho m}\,P_{-\frac{1}{2}+i\rho}^{|m|}(\cosh\eta)\,Y_m(\phi),
$$
...
$$
\begin{align}
\langle \Psi_{\rho m},\Psi_{\rho' m'}\rangle
 &= \delta_{mm'}\,|N_{\rho m}|^2
	 \int_0^{\infty}\!\mathrm{d}\eta\,\sinh\eta\,
		P_{-\frac{1}{2}+i\rho}^{|m|}(\cosh\eta)
		P_{-\frac{1}{2}+i\rho'}^{|m|}(\cosh\eta)^*.
\end{align}
$$
...
$$
\mathcal{N}_m(\rho)
 = \frac{\pi}{2}\,\frac{\bigl|\Gamma(\tfrac12+m+i\rho)\bigr|^2}{\rho\,\tanh(\pi\rho)},
$$
...
\int_1^{\infty}\!\mathrm{d}z\,
 P_{-\frac{1}{2}+i\rho}^{|m|}(z)
 P_{-\frac{1}{2}+i\rho'}^{|m|}(z)^*
 = \mathcal{N}_{|m|}(\rho)\,\delta(\rho-\rho').
$$
...
$$
N_{\rho m}
 = \left[\mathcal{N}_{|m|}(\rho)\right]^{-1/2}
 = \left[\frac{\pi}{2}\,\frac{\bigl|\Gamma(\tfrac12+|m|+i\rho)\bigr|^2}{\rho\,\tanh(\pi\rho)}\right]^{-1/2},
$$
...
$$
\sum_{m\in\mathbb{Z}}\int_0^{\infty}\!\mathrm{d}\rho\,
 \Psi_{\rho m}(\eta,\phi)
 \Psi_{\rho m}^*(\eta',\phi')
 = \frac{1}{\sinh\eta}\,\delta(\eta-\eta')\,\delta(\phi-\phi').
$$
...
$$
c_{\rho m} = \langle\Psi_{\rho m},\Phi\rangle
 = \int_0^{2\pi}\!\mathrm{d}\phi'\int_0^{\infty}\!\mathrm{d}\eta'\,\sinh\eta'\,
	 \Psi_{\rho m}^*(\eta',\phi')\,\Phi(\eta',\phi').
$$
...
\begin{align}
\Phi(\eta,\phi)
 &= \sum_{m\in\mathbb{Z}}\int_0^{\infty}\!\mathrm{d}\rho\,\Psi_{\rho m}(\eta,\phi)
	 \int_0^{2\pi}\!\mathrm{d}\phi'\int_0^{\infty}\!\mathrm{d}\eta'\,\sinh\eta'\,
	 \Psi_{\rho m}^*(\eta',\phi')\,\Phi(\eta',\phi') \\
 &= \int_0^{2\pi}\!\mathrm{d}\phi'\int_0^{\infty}\!\mathrm{d}\eta'\,\sinh\eta'\,
	 \Biggl[\sum_{m\in\mathbb{Z}}\int_0^{\infty}\!\mathrm{d}\rho\,
		\Psi_{\rho m}(\eta,\phi)\Psi_{\rho m}^*(\eta',\phi')\Biggr]\Phi(\eta',\phi').
\end{align}
$$
...
$$
K\bigl((\eta,\phi);(\eta',\phi')\bigr)
 := \sum_{m\in\mathbb{Z}}\int_0^{\infty}\!\mathrm{d}\rho\,
		\Psi_{\rho m}(\eta,\phi)\Psi_{\rho m}^*(\eta',\phi').
$$
...
\Phi(\eta,\phi)
 = \int_0^{2\pi}\!\mathrm{d}\phi'\int_0^{\infty}\!\mathrm{d}\eta'\,\sinh\eta'\,
	 K\bigl((\eta,\phi);(\eta',\phi')\bigr)\,\Phi(\eta',\phi').
$$
...
4. 适当选择归一化常数 $N_{\rho m}$ 后，本征函数
	$$
	\Psi_{\rho m}(\eta,\phi)
	= N_{\rho m}\,P_{-\frac{1}{2}+i\rho}^{|m|}(\cosh\eta)
	  \frac{e^{im\phi}}{\sqrt{2\pi}}
	$$
...
1. **放在本征函数一侧：** 像我们现在这样，要求
	...
	$$
	\Phi(\eta,\phi)
	= \sum_{m\in\mathbb{Z}}\int_0^{\infty}\!\mathrm{d}\rho\,c_{\rho m}\,\Psi_{\rho m}(\eta,\phi),
	$$
...
2. **放在谱测度一侧：** 也可以选择一个“简单的”本征函数归一化（比如去掉 $N_{\rho m}$ 里复杂的 $\rho$ 依赖），改用非平的谱测度 $\mu_{\mathrm{Pl}}(\rho)\,\mathrm{d}\rho$ 来写展开
	$$
	\Phi(\eta,\phi)
	= \sum_{m\in\mathbb{Z}}\int_0^{\infty}\!\mu_{\mathrm{Pl}}(\rho)\,\mathrm{d}\rho\,
	  	ilde c_{\rho m}\,\tilde\Psi_{\rho m}(\eta,\phi),
	$$
...
$$
	ilde\Psi_{\rho m}(\eta,\phi)
 := P_{-\frac12+i\rho}^{|m|}(\cosh\eta)\,\frac{e^{im\phi}}{\sqrt{2\pi}},
$$

此时内积为

$$
\langle \tilde\Psi_{\rho m},\tilde\Psi_{\rho' m'}\rangle
 = \delta_{mm'}\,\mathcal{N}_{|m|}(\rho)\,\delta(\rho-\rho'),
$$
...
\Phi(\eta,\phi)
 = \sum_{m\in\mathbb{Z}}\int_0^{\infty}\!\mu_{\mathrm{Pl}}(\rho)\,\mathrm{d}\rho\,
	a_{\rho m}\,\tilde\Psi_{\rho m}(\eta,\phi),
$$
...
$$
\|\Phi\|_{L^2(H_2)}^2
 = \sum_m\int_0^{\infty}\!\mathrm{d}\rho\,|c_{\rho m}|^2
$$
...
$$
\mu_{\mathrm{Pl}}(\rho)
 \propto \frac{1}{\mathcal{N}_{|m|}(\rho)}
 \propto \frac{\rho\,\tanh(\pi\rho)}{\bigl|\Gamma(\tfrac12+|m|+i\rho)\bigr|^2}.
$$
...
$$
\boxed{\displaystyle
\mathrm{d}\mu_{\mathrm{Pl}}(\rho)
 \propto \rho\,\tanh(\pi\rho)\,\mathrm{d}\rho.}
$$
...
$$
\Gamma\bigl(\tfrac12+|m|+i\rho\bigr)^*
 = \Gamma\bigl(\tfrac12+|m|-i\rho\bigr),
$$
...
$$
\Gamma\bigl(\tfrac12+|m|+i\rho\bigr)
 = \Biggl[\prod_{k=0}^{|m|-1}\bigl(\tfrac12+i\rho+k\bigr)\Biggr]\Gamma\bigl(\tfrac12+i\rho\bigr),
$$
...
$$
\Gamma\bigl(\tfrac12+i\rho\bigr)\Gamma\bigl(\tfrac12-i\rho\bigr)
 = \frac{\pi}{\cosh(\pi\rho)},
$$
