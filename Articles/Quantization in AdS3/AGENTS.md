...
- Avoid Mathematica protected built-in symbols as temporary variable names in checks. In particular, do not assign to `C` or `Gamma`; use descriptive names such as `cotton`, `gammaConn`, or `christoffel` instead.
