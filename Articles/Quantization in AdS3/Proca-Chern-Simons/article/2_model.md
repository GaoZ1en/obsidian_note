...
and the same falloffs hold for the corresponding variations. As shown in [[Articles/Quantization in AdS3/Proca-Chern-Simons/arxiv/appendix_a|Appendix_A]], these asymptotic conditions ensure that the action and the physical quantities entering the covariant phase space analysis remain finite. Therefore, the theory admits a well-defined variational principle without the need for additional boundary counterterms.
