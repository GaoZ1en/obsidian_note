...
this is the same $\displaystyle{(1,1)}$ primary as in [[Articles/Quantization in AdS3/electric field/solving modes/highest weight|highest weight]], up to the overall phase fixed by the duality convention. the descendant potentials can therefore be written as
