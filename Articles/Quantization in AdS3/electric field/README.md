...
Quantization of Maxwell electric-field modes in global AdS3.

## Article draft

| File | Description |
|---|---|
| `article/1_model.md` | Global AdS3 background, Maxwell action, and asymptotic boundary conditions |
| `article/2_hamiltonian_and_symmetries.md` | Covariant phase-space structure and Noether charges for AdS3 Killing symmetries |
| `article/3_mode_solutions.md` | Normalizable mode solutions in temporal gauge and in the dual scalar field-strength basis |
| `article/4_quantization.md` | Temporal-gauge mode expansion, oscillator generators, and canonical quantization |
| `article/5_euclidean_green_function.md` | Euclidean two-point function from temporal-gauge mode sums |
| `article/6_partition_function.md` | Canonical thermal partition function of the propagating Maxwell oscillators |
...
| File | Role |
|---|---|
| `asymptotic behavior.md` | Refined Maxwell falloffs and finiteness estimates |
| `boundary action.md` | Boundary variation checks for highest-weight branches |
| `Dirac.md` | Dirac formalism and canonical constraints |
