...
$$\begin{align}
\lambda_{n,\bar n}(x_{1})\chi_{n,\bar n}^{*}(x_{2})
&=\mathcal Q_1\left(\chi_{n,\bar n}(x_{1})\chi_{n,\bar n}^{*}(x_{2})\right), \\
\chi_{n,\bar n}(x_{1})\lambda_{n,\bar n}^{*}(x_{2})
&=\mathcal Q_2\left(\chi_{n,\bar n}(x_{1})\chi_{n,\bar n}^{*}(x_{2})\right)
\end{align}$$
