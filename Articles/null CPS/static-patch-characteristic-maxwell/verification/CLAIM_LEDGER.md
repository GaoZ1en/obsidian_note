...
| N-10 | The repaired $dS_4$ project presently clears the article novelty gate. | false | `kill-test-audit.md`; `literature/literature-comparison.md`, section 11 | Final verdict is freeze; reopen only for a demonstrated null-specific algebra/state input, not SdS/Nariai. |
