...
\tag{1.10}
\begin{align}
-\frac{1}{16\pi G}\int_{\Sigma_{\varepsilon,f}-\Sigma_{\varepsilon,i}}\mathrm{d}^{2x}\sqrt{ \sigma }\tilde{\nabla}_{\nu}(\sigma^{\mu \nu}\tau^{\lambda}\delta g_{\mu \lambda} & )
\end{align}
$$
