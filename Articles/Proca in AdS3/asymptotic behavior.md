...
{h^{(+)}_{-,m=0,n}}^{\mu} & = -2i^{2n+1}\sqrt{ \pi } \frac{1+n}{\mu+2n+2} \sqrt{ \frac{1+n}{\mu+n+1} }{f^{(+)}_{r,n,n+1}}^{\mu} \\
 & +2i^{2n+1} \frac{\mu+n+1}{\mu+2n+2} \sqrt{ \frac{1+n}{\mu+n+1} }{f^{(+)}_{l,n+1,n}}^{\mu} \\
...
{f^{(+)}_{r,n,n+1}}^{\mu} & = (-i)^{2n+2}\frac{1}{2\mu \sqrt{ \pi }}\sqrt{ \frac{\mu+1+n}{1+n} }\left((\mu+2+n) P_{n}^{(\mu+1,1)}\left(\frac{r^{2}-1}{r^{2}+1}\right)-(n+1)P_{n-1}^{(\mu+1,1)}\left(\frac{r^{2}-1}{r^{2}+1}\right)\right)e^{-i(\mu+2+2n)t}r(1+r^{2})^{-(\mu+2)/2} \\
{h^{(+)}_{+,m=0,n}}^{r} & = 2i^{2n+1}\sqrt{ \pi } \frac{\mu+n+1}{\mu+2n+2} \sqrt{ \frac{1+n}{\mu+n+1} } {f^{(+)}_{r,n,n+1}}^{r} \\
 & -2i^{2n+1}\sqrt{ \pi } \frac{1+n}{\mu+2n+2} \sqrt{ \frac{1+n}{\mu+n+1} }{f^{(+)}_{l,n+1,n}}^{r} \\
\end{align}$$
