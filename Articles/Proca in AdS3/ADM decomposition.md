...
$$\tag{.}\begin{align}
\frac{i\omega}{2\pi}\Omega(A^{\mu}_{(n+1)m+},A^{\nu}_{nm-}) & =-4m\int \mathrm{d}rr^{m-1}(1+r^{2})^{-(\mu+m)/2}P^{(\mu,m-1)}_{n+1}\left( \frac{r^{2}-1}{r^{2}+1} \right)\partial _{r}\left( r^{m+1}(1+r^{2})^{-(\mu+m+2)/2}P_{n}^{(\mu,m+1)}\left( \frac{r^{2}-1}{r^{2}+1} \right) \right) \\
...
$$\tag{.}\begin{align}
\Phi _{nm\pm} & =r^{m\mp 1}(1+r^{2})^{-(\mu+m\mp1+1)/2}P^{(\mu,m\mp 1)}_{n}\left( \frac{r^{2}-1}{r^{2}+1} \right) \\
\Phi _{(n+1)m+} & =r^{m-1}(1+r^{2})^{-(\mu+m)/2}P_{n+1}^{(\mu,m-1)}\left( \frac{r^{2}-1}{r^{2}+1} \right) \\
\Phi _{nm-} & =r^{m+1}(1+r^{2})^{-(\mu+m+2)/2}P_{n}^{(\mu,m+1)}\left( \frac{r^{2}-1}{r^{2}+1} \right) \\
\Phi _{(n+1)m+}\Phi _{nm-} & =r^{2m}(1+r^{2})^{-\mu-m-1}P_{n+1}^{(\mu,m-1)}\left( \frac{r^{2}-1}{r^{2}+1} \right)P^{(\mu,m+1)}_{n}\left( \frac{r^{2}-1}{r^{2}+1} \right)
\end{align}$$

$$\tag{.}\begin{align}
\frac{i\omega}{2\pi}\Omega(A^{\mu}_{(n+1)m+},A^{\nu}_{nm-}) & =-4m\int \mathrm{d}rr^{m-1}(1+r^{2})^{-(\mu+m)/2}P^{(\mu,m-1)}_{n+1}\left( \frac{r^{2}-1}{r^{2}+1} \right)\partial _{r}\left( r^{m+1}(1+r^{2})^{-(\mu+m+2)/2}P_{n}^{(\mu,m+1)}\left( \frac{r^{2}-1}{r^{2}+1} \right) \right) \\
 & +2\int \mathrm{d}r \left[ (\omega ^{2}-\mu ^{2}-m^{2})r^{2}-2m^{2} \right]r^{2m-1}(1+r^{2})^{-(\mu+m+2)}P_{n+1}^{(\mu,m-1)}\left( \frac{r^{2}-1}{r^{2}+1} \right)P^{(\mu,m+1)}_{n}\left( \frac{r^{2}-1}{r^{2}+1} \right) \\
 & -4m(m+1)\int \mathrm{d}rr^{2m-1}(1+r^{2})^{-(\mu+m+1)}P_{n+1} & 
\end{align}$$