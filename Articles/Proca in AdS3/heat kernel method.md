...
here we subtracted the divergent $\displaystyle{n=0}$ term corresponding to the infinite volume of thermal AdS3 (vacuum fluctuations). evaluating the integral we get
...
S(t,r) & =\frac{4t^{1/2}e^{-\mu ^{2}t}}{(4\pi)^{3/2}} \frac{e^{-r^{2}/4t}}{\sinh r}\int ^{1}_{0}\mathrm{d}\xi e^{-t(1-\xi)^{2}}\sinh r\xi
\end{align}$$
...
-\ln \det \Delta _{\mu}^{~\nu} & =-3\mathrm{Vol}(\mathbb{H}_{3}/\mathbb{Z})\int ^{\infty}_{0} \frac{\mathrm{d}t}{t} (F+\partial _{u}S)|_{u=0} \\
 & +2\sum _{n=1}^{\infty} \frac{(2\pi \tau _{2})(2\pi)}{4|\sin \pi n\tau|^{2}} \int ^{\infty}_{0} \frac{\mathrm{d}t}{t} \int ^{\infty}_{2\pi \tau _{2}} \mathrm{d}r\sinh r\left((F+\partial _{u}S)A_{\gamma ^{n}}+\partial _{u}^{2}SB_{\gamma ^{n}}\right) \\
 & =-3\mathrm{Vol}(\mathbb{H}_{3}/\mathbb{Z})\int ^{\infty}_{0} \frac{\mathrm{d}t}{t}(F+\partial _{u}S)|_{u=0} \\
 & +2\sum ^{\infty}_{n=1} \frac{(2\pi \tau _{2})(2\pi)}{4|\sin \pi n\tau|^{2}}\int ^{\infty}_{0} \frac{\mathrm{d}t}{t} e^{-\mu ^{2}t} \frac{e^{-\frac{(2\pi n\tau _{2})^{2}}{4t}}}{4\pi ^{3/2}\sqrt{ t }}\left(2\cos(2\pi n\tau _{1})+e^{-t}\right)
\end{align}$$

the first line is the divergent vacuum energy term which we drop. evaluating the integral we get

$$\begin{align}
-\ln \det \Delta _{\mu}^{~\nu} & =\sum ^{\infty}_{n=1} \frac{1}{4n|\sin \pi n\tau|^{2}}\left(e^{-2\pi n\tau _{2}\sqrt{ \mu ^{2}+1 }}+2\cos(2\pi n\tau _{1})e^{-2\pi n\tau _{2}\mu}\right) \\
...
$$\begin{align}
Z^{\text{1-loop}}_{\text{Proca}} & =\prod ^{\infty}_{\ell,\ell'=0}\frac{1}{(1-q^{\ell+\mu+1}\bar{q}^{\ell'})(1-q^{\ell'}\bar{q}^{\ell+\mu+1})}
\end{align}$$
