...
$$\begin{align}
A^{t} & \propto R_{>}^{(-1)}(r)\int _{0}^{\infty}\mathrm{d}r' R_{<}^{(-1)}(r')r'^{2}(1+r'^{2})^{-(\mu+3)/2} \\
 & \propto r(1+r^{2})^{-(\mu+3)/2}{}_{2}F_{1}\left(\frac{1}{2}(\mu+1),\frac{1}{2}(\mu+3);1+\mu; \frac{1}{1+r^{2}}\right)
\end{align}$$
