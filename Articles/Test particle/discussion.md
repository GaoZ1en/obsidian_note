...
$$\begin{align}
T^{\mu \nu}_{\text{matter}} & =\frac{2}{\sqrt{ -g }} \delta
\end{align}$$

consider a infinitesimal diffeomorphism transformation generated by a vector $\displaystyle{\xi ^{\mu}}$
