$$\tag{1.1}
\begin{align}
\ell & =\frac{1}{32\pi G\mu}(-z\log zD_{a}g_{zb}+z\gamma _{ac}\tilde{\Gamma}^{c}_{bd}\gamma ^{de}g_{ze}) \mathrm{d}x^{a}\wedge \mathrm{d}x^{b}
\end{align}
$$

$$\tag{1.1}
\begin{align}
\delta \ell & =(-z\log zD_{a}\delta g_{zb}+z+z\gamma _{ac}\tilde{\Gamma}^{c}_{bd}\gamma ^{de}\delta g_{ze})\mathrm{d}x^{a}\wedge \mathrm{d}x^{b}
\end{align}
$$
