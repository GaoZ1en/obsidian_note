...
date: 2026-06-13
summary: "Rewrites the Maxwell theory as a covariant Hamiltonian system and records the Noether charges associated with the AdS3 Killing symmetries."
---

# 2. Reformulating the model as a Hamiltonian system

In this section, we apply the covariant phase-space formalism to the Maxwell theory with the falloffs of Section 1. We first rewrite the model as a Hamiltonian system and then discuss the Noether charges associated with the Killing symmetries. Appendix A shows that the near-boundary contributions at spatial infinity vanish.
...
The boundary term produced at spatial infinity vanishes under the asymptotic conditions of Section 1 together with the radial derivative behavior summarized in Appendix A. From the bulk term we read off the equation of motion
...
We define the pre-phase space $\widetilde{\mathcal{P}}$ as the space of solutions of the Maxwell equation obeying the asymptotic boundary conditions of Section 1. Taking the exterior derivative on configuration space gives the symplectic form
...
Appendix A shows that this symplectic form is finite on $\widetilde{\mathcal{P}}$. At this stage, the Maxwell theory has been rewritten as a Hamiltonian system specified by $\widetilde{\mathcal{P}}$ and $\omega|_{\widetilde{\mathcal{P}}}$.
...
For the global AdS$_3$ Killing fields introduced in Section 1, one has the asymptotic behavior
