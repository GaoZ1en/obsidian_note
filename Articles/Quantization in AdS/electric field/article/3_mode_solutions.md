...
$$\begin{align}
\omega_{nm}&=2n+2+|m|, & n&\in\mathbb{N}, & m&\in\mathbb{Z},
\end{align}$$
...
$$\begin{align}
A^{t}_{nm}&=0, & A^{r}_{nm}&=O(r^{-1}), & A^{\phi}_{nm}&=O(r^{-2}).
\end{align}$$
...
$$\begin{align}
\mathcal{C}\phi&=-\frac{1}{4}\nabla^{2}\phi, & \bar{\mathcal{C}}\phi&=-\frac{1}{4}\nabla^{2}\phi.
\end{align}$$

Therefore every solution of the massless equation satisfies

$$\begin{align}
\mathcal{C}\phi&=0, & \bar{\mathcal{C}}\phi&=0.
\end{align}$$

We now consider a scalar primary. The highest-weight conditions are

$$\begin{align}
\mathcal{L}_{\xi_{1}}\phi&=0, & \mathcal{L}_{\bar{\xi}_{1}}\phi&=0, \\
\mathcal{L}_{\xi_{0}}\phi&=-ih\phi, & \mathcal{L}_{\bar{\xi}_{0}}\phi&=-i\bar{h}\phi.
\end{align}$$

Acting with the Casimir operators on such a primary gives

$$\begin{align}
h(h-1)&=0, & \bar{h}(\bar{h}-1)&=0.
\end{align}$$

Hence there are four candidate branches,

$$\begin{align}
(h,\bar{h})&=(0,0), & (h,\bar{h})&=(1,0), & (h,\bar{h})&=(0,1), & (h,\bar{h})&=(1,1).
\end{align}$$
...
$$\begin{align}
\phi_{k,\bar{k}}&=\frac{\mathcal{L}_{\xi_{-1}}^{k}\mathcal{L}_{\bar{\xi}_{-1}}^{\bar{k}}\phi_{0,0}}{\sqrt{k!(k+1)!\bar{k}!(\bar{k}+1)!}}, & k,\bar{k}&=0,1,2,\ldots
\end{align}$$
...
$$\begin{align}
F^{tr}[A_{nm}]&=-\frac{1}{r}\partial_{t}\partial_{\phi}\Psi_{nm}, & F^{t\phi}[A_{nm}]&=\frac{1}{r}\partial_{t}\partial_{r}\Psi_{nm}, & F^{r\phi}[A_{nm}]&=-\frac{1}{r}\partial_{t}^{2}\Psi_{nm}.
\end{align}$$
...
$$\begin{align}
V_{t}[A_{nm}]&=-\partial_{t}^{2}\Psi_{nm}, & V_{r}[A_{nm}]&=-\partial_{t}\partial_{r}\Psi_{nm}, & V_{\phi}[A_{nm}]&=-\partial_{t}\partial_{\phi}\Psi_{nm}.
\end{align}$$
