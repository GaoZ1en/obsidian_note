\section{Euclidean correlation function}\label{sec:euclidean-correlation-function}
...
\subsection{Euclidean background and modes}\label{subsec:euclidean-temporal-gauge-modes}
...
\subsection{Time-ordered mode sum}\label{subsec:mode-sum}
...
\subsection{Reduction to a scalar kernel}\label{subsec:scalar-mode-sum}
