\section{\texorpdfstring{The Maxwell theory in the global AdS$_3$ spacetime}{The Maxwell theory in the global AdS3 spacetime}}\label{sec:maxwell-fields-global-ads3}
...
\subsection{Spacetime background}\label{subsec:spacetime-background}
...
These Killing fields will be used in Section \ref{sec:hamiltonian-and-symmetries} when we discuss the symmetry generators on the Maxwell phase space.

\subsection{The action and asymptotic boundary conditions}\label{subsec:action-eom}
