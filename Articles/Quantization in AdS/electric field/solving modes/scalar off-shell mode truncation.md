...
$$\begin{align}
S_{R}
&=-\frac{1}{2}\int_{r\leq R}\mathrm{d}^{3}x\sqrt{-g}
\left(\nabla_{\mu}\Phi\nabla^{\mu}\Phi+M^{2}\Phi^{2}\right)
-\frac{\Delta}{2}\int_{r=R}\mathrm{d}^{2}x\sqrt{-\gamma}\,\Phi^{2}.
\end{align}$$
...
$$\begin{align}
\Phi_{\ell,N}(t,r,\phi)
&=Y_m(\phi)\left[q_s(t)s_{\ell}(r)
+\sum_{n=0}^{N-1}q_n(t)f_{n\ell}(r)\right].
\end{align}$$
...
$$\begin{align}
\Phi_{\ell,N}
&=Y_m\left[q_s r^{-\Delta}
+\left(\sum_{n=0}^{N-1}c_nq_n\right)r^{\Delta-2}
+\cdots\right].
\end{align}$$
...
$$\begin{align}
a_{p\ell}-\frac{(\Delta)_p}{p!}s_{\ell}
&=\mathcal{O}(r^{-\Delta-2}),
\end{align}$$
...
$$\begin{align}
L_{\ell,N}
&=\frac{1}{2}\dot{q}^{T}G\dot{q}-\frac{1}{2}q^{T}Kq, \\
G_{ij}
&=\int_{0}^{\infty}\mathrm{d}r\,w(r)u_i(r)u_j(r), \\
K_{ij}
&=\lim_{R\to\infty}\left[
\int_{0}^{R}\mathrm{d}r
\left(p(r)u_i'(r)u_j'(r)+V_{\ell}(r)u_i(r)u_j(r)\right)
+\Delta R\sqrt{1+R^{2}}\,u_i(R)u_j(R)
\right].
\end{align}$$
...
$$\begin{align}
y&:=\frac{r^{2}}{1+r^{2}}, &
\frac{r\,\mathrm{d}r}{1+r^{2}}&=\frac{\mathrm{d}y}{2(1-y)}.
\end{align}$$
...
$$\begin{align}
G_{ss}
&=\frac{1}{2}\int_{0}^{1}\mathrm{d}y\,
y^{\ell}(1-y)^{\Delta-1}
=\frac{1}{2}B(\ell+1,\Delta).
\end{align}$$
...
$$\begin{align}
P_n^{(\alpha,\ell)}(2y-1)
&=\frac{(-1)^n}{n!}y^{-\ell}(1-y)^{-\alpha}
\frac{\mathrm{d}^{n}}{\mathrm{d}y^{n}}
\left[y^{n+\ell}(1-y)^{n+\alpha}\right],
\end{align}$$
...
$$\begin{align}
G_{sf_n}
&=\frac{(1-\Delta)_n}{2n!(\ell+n+1)} \\
&=\frac{(1-\Delta)(\Delta_+)_n}
{2n!(n+1-\Delta)(\ell+n+1)}.
\end{align}$$
...
&=\frac{1}{2}\int_{0}^{1}\mathrm{d}y\,
y^{\ell}(1-y)^{\Delta_+-1}
P_n^{(\Delta_+-1,\ell)}(2y-1)
P_k^{(\Delta_+-1,\ell)}(2y-1) \\
&=\delta_{nk}
\frac{(n+1)_{\ell}}
{2(\Delta_++n)_{\ell}(\Delta_++\ell+2n)}.
\end{align}$$
...
$$\begin{align}
-\frac{\mathrm{d}}{\mathrm{d}r}\left(p(r)u'(r)\right)
+V_{\ell}(r)u(r)
&=\lambda w(r)u(r).
\end{align}$$
...
$$\begin{align}
\lambda_s&=(\ell+\Delta)^2, &
\lambda_{f_n}&=(\ell+\Delta_++2n)^2.
\end{align}$$
...
+\lim_{R\to\infty}\left[
p(R)s_{\ell}'(R)u(R)
+\Delta R\sqrt{1+R^{2}}s_{\ell}(R)u(R)
\right].
\end{align}$$
...
K_{f_nf_k}
&=\delta_{nk}(\Delta_++\ell+2n)^2G_{f_nf_n}.
\end{align}$$
...
$$\begin{align}
\widetilde{s}_{\ell}(r)
&=s_{\ell}(r)\left(1+\frac{1}{2(1+r^{2})}\right)
=s_{\ell}(r)+\frac{1}{2}h_{\ell}(r), \\
...
$$\begin{align}
G_{\widetilde{s}f_n}
&=G_{sf_n}+\frac{1}{2}G_{hf_n}, \\
K_{\widetilde{s}f_n}
&=\lambda_sG_{sf_n}+\frac{1}{2}\lambda_{f_n}G_{hf_n}.
\end{align}$$
