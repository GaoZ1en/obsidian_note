...
The work extends the two interval YM notes, repairs the gauge template's trace-group domain, and adds the [open-chord CS model](<Articles/Quantization in AdS/gluing/models/spacelike regions/gauge/U(1) Chern-Simons disk and open-chord sewing.md>) and [self-sewing topology note](<Articles/Quantization in AdS/gluing/archived/self-sewing topology and orientation.md>). Prior conversation verdicts and old “Verified” labels were treated as claims, not evidence.
