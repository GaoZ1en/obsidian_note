...
3. 同一 [1D scalar construction](<Articles/Quantization in AdS/gluing/models/spacelike regions/non-gauge/1+1 scalar.md>) 的 finite truncation 验证上面的 $\rho_N$ equation、完整 $(2N+1)$-pair canonical system 与 generalized normal-mode map。
