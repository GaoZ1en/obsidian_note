...
Date: 2026-09-07. This record accompanies the [free implementation](<Articles/Quantization in AdS/gluing/archive/2026-09-23/04-observable-algebra/scalar-local-structure/scalar local structure implementation.md>), [finite-insertion obstruction](<Articles/Quantization in AdS/gluing/archive/2026-09-23/04-observable-algebra/scalar-local-structure/scalar insertion time-slice obstruction.md>), [switched-phi4 calculations](<Articles/Quantization in AdS/gluing/archive/2026-09-23/04-observable-algebra/scalar-local-structure/scalar interacting local structure.md>), and the separately [completed relative-S construction](<Articles/Quantization in AdS/gluing/archive/2026-09-23/04-observable-algebra/scalar-local-structure/scalar completed relative-S local structure.md>). It records an author verification, not an independent-agent review.
...
| Higher completed relative-S target | Separate [completed construction](<Articles/Quantization in AdS/gluing/archive/2026-09-23/04-observable-algebra/scalar-local-structure/scalar completed relative-S local structure.md>): multi-insertion coefficients, explicit Laurent/nonnegative saturation and controlled representative limits; compact Cauchy compensation, compatible local cutoffs, and an actual coefficient-recursive formal inverse |
