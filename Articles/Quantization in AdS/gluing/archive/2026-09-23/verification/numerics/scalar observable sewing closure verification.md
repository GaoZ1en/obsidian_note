...
Scope: [scalar closure note](<Articles/Quantization in AdS/gluing/archive/2026-09-23/04-observable-algebra/scalar-local-structure/scalar observable sewing closure.md>), its exact class distinctions, the scalar portions of README/TODO, and short pointers in the original scalar notes. Existing gauge and other working-tree edits were preserved. No commit or push was requested.
