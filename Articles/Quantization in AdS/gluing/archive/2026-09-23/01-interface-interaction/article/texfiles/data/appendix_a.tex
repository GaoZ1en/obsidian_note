\section{Four-region gluing}\label{app:four-regions}
...
\subsection{Four quadrants and independent edge couplings}\label{subsec:four-region-edges}
...
\subsection{Separable Kronecker structure}\label{subsec:four-region-separable}
...
\subsection{Nonseparable finite-matrix checks}\label{subsec:four-region-nonseparable}
