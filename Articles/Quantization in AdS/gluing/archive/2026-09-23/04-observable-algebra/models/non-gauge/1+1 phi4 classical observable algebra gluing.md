...
The construction follows the regional-response picture of [the free example](<../../formalism/Untitled.md>). All equalities between displayed perturbative coefficients are understood modulo $\lambda^3$. The recursions also specify higher formal coefficients; no convergence of the resulting series is needed.
