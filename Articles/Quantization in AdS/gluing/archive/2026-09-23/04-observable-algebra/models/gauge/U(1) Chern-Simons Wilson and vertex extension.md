...
用 [disk 模型](<Articles/Quantization in AdS/gluing/archive/2026-09-23/04-observable-algebra/models/gauge/U(1) Chern-Simons disk and open-chord sewing.md>) 的 $\Omega(u,w)=-k\oint u\,dw/(2\pi)$。在不同 physical points $P,Q$ 取 smooth unit-integral approximate identities，令
$$
