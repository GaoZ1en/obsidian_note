...
The shared coefficient $q$ enforces continuity at the artificial cut. The outer Dirichlet conditions are built into the basis. The mass and stiffness matrices of [[Articles/Quantization in AdS/gluing/archive/2026-09-23/02-boundary-history-response/regulators-and-fock/port-canonical-normal-form|port-canonical-normal-form]] are the restrictions of the $H$ inner product and $\mathfrak a$ to $W_N$.
