...
这里的标记是穿过空间切片的 Wilson worldlines，尚未把任意几何 corner 或 boundary Wilson endpoint 识别成 puncture。量子版本另见 [两个非真空通道](<Articles/Quantization in AdS/gluing/models/spacelike regions/gauge/SU(2) Chern-Simons charged sewing and channel maps.md>)。
