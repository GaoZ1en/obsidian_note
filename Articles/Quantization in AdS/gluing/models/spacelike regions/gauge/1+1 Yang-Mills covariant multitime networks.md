...
使用 [YM classical note](<Articles/Quantization in AdS/gluing/models/spacelike regions/gauge/1+1 Yang-Mills classical observable algebra gluing.md>) 的 action
$$
