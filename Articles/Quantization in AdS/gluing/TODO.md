...
- [x] Execute phase A of [the scalar local-structure route](<Articles/Quantization in AdS/gluing/archived/scalar local structure research route.md>): record the actual regional inputs, transpose/matching dependencies and original test classes in the implementation note §1.
