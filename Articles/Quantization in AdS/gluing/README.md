...
- `spatial gauge gluing audit.md`: repaired A--Q audit of the spatial-subregion gauge branch, including dual traces and passive versus active gauge roles. It records the Maxwell $2+1$ smooth-core orbit/time-slab upgrade while keeping the general gauge-slice, bulk-unfixing, extension-image, weak-patching, CPS, observable-algebra, and BRST/BV theorems conditional.
