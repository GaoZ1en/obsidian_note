...
- [U(1) Wilson and vertex extension](<models/U(1) Chern-Simons Wilson and vertex extension.md>): smooth regularization, the failure of a strong sharp Weyl limit, charged mode domains, ordered renormalized products and sewing with a common prescription.
