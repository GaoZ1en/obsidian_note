...
- `history-indexed observable algebra gluing.md`: independent algebra-first research track defining fixed-history affine CCR algebras, compatible history transports, smeared response derivations, and kill tests. It proves a two-interval continuum CCR assembly benchmark using regional action/response data; fusion internal to the quantized history fibers and the crossed-product/opposite-module identifications remain open.
