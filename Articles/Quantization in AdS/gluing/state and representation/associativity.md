...
give the same connected theory. Here $\#_{q_a}$ means: identify the two traces at $x_a$, then vary their common value to derive the signed flux equation. At finite cutoff both common ports and their canonical momenta are retained, as in [[Articles/Quantization in AdS/gluing/models/spacelike regions/non-gauge/1+1 scalar|1+1 scalar]].
...
is conserved because the endpoint histories are fixed under regional variations. As in [[Articles/Quantization in AdS/gluing/models/spacelike regions/non-gauge/1+1 scalar|1+1 scalar]], a nonconstant prescribed history is changed by time translation, so a region is driven and its regional energy satisfies the boundary-work law
...
Following [[Articles/Quantization in AdS/gluing/models/spacelike regions/non-gauge/1+1 scalar|1+1 scalar]], first keep the endpoint histories prescribed and distinct. Write
