\section{Gauge fixing and mode selection}\label{gauge-fixing-and-mode-selection}

This appendix collects the subtle points behind the mode construction in Section 2.

\subsection{TT gauge representatives}\label{tt-gauge-representatives}

We follow the field-space decomposition used in \href{https://arxiv.org/pdf/2109.06938}{Acosta--Garbarz--Goya--Leston}. An off-shell metric perturbation is organized as
...
\subsection{Casimir eigenvalues and highest weights}\label{casimir-eigenvalues-and-highest-weights}
