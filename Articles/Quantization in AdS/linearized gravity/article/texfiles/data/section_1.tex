\section{\texorpdfstring{Linearized Einstein gravity in global AdS\(_3\)}{Linearized Einstein gravity in global AdS\_3}}\label{linearized-einstein-gravity-in-global-ads_3}
...
\subsection{Spacetime background}\label{spacetime-background}
...
\subsection{Action and boundary conditions}\label{action-and-boundary-conditions}
...
\subsection{Covariant phase space formalism}\label{covariant-phase-space-formalism}
