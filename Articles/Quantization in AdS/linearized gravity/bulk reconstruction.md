...
$$\begin{align}
\varphi_{n,m}(t,r,\phi) &= \mathcal N_{n,m}\, e^{-i\omega_{n,m}t}e^{im\phi} r^{|m|}(1+r^2)^{-(\Delta+|m|)/2} P_n^{(\Delta-1,|m|)} \left(\frac{r^2-1}{r^2+1}\right),\\
\omega_{n,m}&=\Delta+2n+|m|,\\
\mathcal N_{n,m} &= \sqrt{\frac{1}{2\pi} \frac{(\Delta+n)_{|m|}}{(n+1)_{|m|}}}, \qquad n\in\mathbb N,\quad m\in\mathbb Z .
\end{align}$$
...
$$\begin{align}
\varphi_{n,m}(t,r,\phi) &\sim B_{n,m}\, r^{-\Delta}e^{-i\omega_{n,m}t}e^{im\phi}, \\
...
$$\begin{align}
\phi(t,r,\phi) = \sum_{n,m} \left[ \frac{\varphi_{n,m}(t,r,\phi)} {cB_{n,m}}\, O_{n,m} +\mathrm{h.c.} \right],
\end{align}$$
...
$$\begin{align}
e^{-i\omega_{n,m}t+im\phi} = e^{-i h_{n,m}u-i\bar h_{n,m}v}, \qquad h_{n,m}=\frac{\omega_{n,m}+m}{2}, \quad \bar h_{n,m}=\frac{\omega_{n,m}-m}{2}.
\end{align}$$

For $m\ge0$, this gives

$$\begin{align}
h_{n,m}=\frac{\Delta}{2}+n+m, \qquad \bar h_{n,m}=\frac{\Delta}{2}+n,
\end{align}$$
...
$$\begin{align}
\Omega[h_{-,n},h^*_{-,m}]=-i\delta_{nm}, \qquad \Omega[h_{+,\bar n},h^*_{+,\bar m}]=-i\delta_{\bar n\bar m}.
\end{align}$$

The two physical towers have primary weights

$$\begin{align}
h_{-,0}:\ (2,0), \qquad h_{+,0}:\ (0,2),
\end{align}$$
...
$$\begin{align}
m=n+2, \qquad \bar m=\bar n+2.
\end{align}$$

On the CFT vacuum module,

$$\begin{align}
\langle 0|L_mL_{-m}|0\rangle =\frac{c}{12}m(m^2-1), \qquad m\ge2,
\end{align}$$
...
$$\begin{align}
a_{-,n}^\dagger \sim \sqrt{\frac{12}{c\,m(m^2-1)}}\,L_{-m}, \qquad a_{-,n} \sim \sqrt{\frac{12}{c\,m(m^2-1)}}\,L_m, \qquad m=n+2,
\end{align}$$
