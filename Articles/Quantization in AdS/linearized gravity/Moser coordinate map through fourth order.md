...
$$\begin{align}
\Omega_t=\Omega_0+t(\Omega-\Omega_0),\qquad Y_t=-\bigl(K_0+t\sum_{r\ge1}\kappa^rK_r\bigr)^{-1}\sum_{r\ge1}\kappa^r\alpha_r.
\end{align}$$
...
$$\begin{align}
Y_t=\kappa V_1+\kappa^2(V_2-tB)+\kappa^3(V_3-tC+t^2D) +\kappa^4(V_4-tE+t^2F-t^3G)+O(\kappa^5).
\end{align}$$
...
$$\begin{aligned}
U_3={}&\mathscr V_3-\frac12\mathscr C+\frac13\mathscr D +\frac12(\mathscr V_1\mathscr V_2+\mathscr V_2\mathscr V_1) -\frac13\mathscr V_1\mathscr B-\frac16\mathscr B\mathscr V_1+\frac16\mathscr V_1^3,
\end{aligned}$$
...
&+\frac12(\mathscr V_1\mathscr V_3+\mathscr V_3\mathscr V_1+\mathscr V_2^2) -\frac13\mathscr V_1\mathscr C-\frac16\mathscr C\mathscr V_1 +\frac14\mathscr V_1\mathscr D+\frac1{12}\mathscr D\mathscr V_1\\
...
$$\begin{align}
\frac{\mathcal L_{W_{n_1,m_1}}\cdots\mathcal L_{W_{n_k,m_k}}} {\prod_{j=1}^k(m_1+\cdots+m_j+j)}.
\end{align}$$
