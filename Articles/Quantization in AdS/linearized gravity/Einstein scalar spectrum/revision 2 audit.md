...
$$\begin{align}
I_+=I_-=-\frac{\Delta^2(8\Delta-3)}{16\pi(2\Delta-1)(2\Delta+1)},\qquad I_s=\frac{\Delta^2(2\Delta-5)}{16\pi(2\Delta-1)(2\Delta+1)(2\Delta+3)},
\end{align}$$

$$\begin{align}
\frac{V_{AB}}G=-32\pi(2I_++I_s) =\frac{2\Delta^2(32\Delta^2+34\Delta-13)}{(2\Delta-1)(2\Delta+1)(2\Delta+3)}.
\end{align}$$
