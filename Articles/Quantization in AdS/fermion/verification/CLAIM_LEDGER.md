...
| Jacobi radial functions solve the full first-order Dirac system | PROVED | analytic intertwining identities; exact Mathematica zero-residual regressions for $n=0,1,2$, both signs of $\kappa$, and $m,-m$ | regular origin, pure BC |
