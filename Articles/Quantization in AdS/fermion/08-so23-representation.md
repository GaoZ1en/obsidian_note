...
$$\begin{align}
C_2[\Delta_\pm,\tfrac12] =\left(\frac32\pm m\right) \left(-\frac32\pm m\right)+\frac34 =m^2-\frac32.
\end{align}$$
...
$$\begin{align}
[H,M_i^\pm]=\pm M_i^\pm, \qquad (M_i^+)^\dagger=M_i^-,
\end{align}$$

$$\begin{align}
[M_i^-,M_j^+] =2\delta_{ij}H-2i\epsilon_{ijk}J_k.
\end{align}$$
...
$$\begin{align}
\langle0,m'|M_i^-M_j^+|0,m\rangle =2\Delta\,\delta_{ij}\delta_{m'm} -2i\epsilon_{ijk}(J_k)_{m'm}.
\end{align}$$

On the tensor product $1\otimes\frac12=\frac32\oplus\frac12$, this matrix has the two eigenvalues

$$\begin{align}
g_{3/2}=2\Delta+1, \qquad g_{1/2}=2(\Delta-1).
\end{align}$$
...
$$\begin{align}
\boxed{ \left\langle1;\frac12,\frac12\right|
M_0^+ \left|0;\frac12,\frac12\right\rangle =\sqrt{\frac{2(\Delta-1)}{3}}.
}
\end{align}$$
...
$$\begin{align}
\boxed{ \left\langle0;\frac12,\frac12\right|
M_0^- \left|1;\frac12,\frac12\right\rangle =\sqrt{\frac{2(\Delta-1)}{3}}.
}
\end{align}$$
...
$$\begin{align}
H\,M_0^+|0,m\rangle =(\Delta+1)M_0^+|0,m\rangle,
\end{align}$$
...
$$\begin{align}
\mathcal H_1^{\rm std}\cong D(\Delta_+,\tfrac12), \qquad \mathcal H_1^{\rm alt}\cong D(\Delta_-,\tfrac12).
\end{align}$$
...
$$\begin{align}
\mathcal F =\Lambda^\bullet\mathcal H_{1,{\rm p}} \widehat\otimes \Lambda^\bullet\mathcal H_{1,{\rm ap}}.
\end{align}$$
...
$$\begin{align}
\widehat Q_\xi =\sum_{I,J}\widehat a_I^\dagger(h_\xi)_{IJ}\widehat a_J +\sum_{I,J}\widehat b_I^\dagger(h_\xi^{\,c})_{IJ}\widehat b_J.
\end{align}$$

The CAR imply

$$\begin{align}
[\widehat Q_\xi,\widehat\psi] =-i\mathcal L^K_\xi\widehat\psi,
\end{align}$$
