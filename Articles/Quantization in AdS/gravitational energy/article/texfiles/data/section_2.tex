\section{covariant phase space and charge matching}\label{sec:covariant-phase-space-charge-matching}

\subsection{first variation and symplectic form}
...
at the timelike boundary, the pullback of the gravitational pre-symplectic potential combines with the variation of the boundary action. with the orientation of Sec.~\ref{sec:theory-setup}, the boundary variational identity is
...
the boundary condition imposed in Sec.~\ref{sec:theory-setup} sets the matter pre-symplectic boundary term on $\displaystyle{\Gamma}$ to zero for every allowed variation.
...
\subsection{perturbative diffeomorphisms and the Noether charge}\label{subsec:perturbative-diffeomorphisms}
...
here $\displaystyle{D_{\mu}}$ is compatible with $\displaystyle{\gamma _{\mu\nu}}$. the matter assumptions of Sec.~\ref{sec:theory-setup} exclude any matter contribution to $\displaystyle{\mu _{\xi}^{[i]}}$.
...
\subsubsection{bulk part of the Noether charge}\label{subsubsec:bulk-noether-charge}
...
\textbf{lemma (background-covariant current reduction).} the Noether current of a local background-diffeomorphism-covariant tensor action takes the form
...
where $\displaystyle{T^{\mu \nu}}$ is the Hilbert stress tensor, $\displaystyle{\mathcal{R}_{\xi}^{\mu}}$ is proportional to the equations of motion, and $\displaystyle{U_{\xi}^{\mu \nu}}$ is an antisymmetric superpotential. here ``$\displaystyle{\approx}$'' denotes equality after imposing the equations of motion. Appendix~\ref{app:matter-diffeomorphism-current} gives the proof.
...
the assumptions of Sec.~\ref{sec:theory-setup} set the matter superpotential contribution to zero.
...
\subsubsection{boundary part of the Noether charge}\label{subsubsec:boundary-noether-charge}
...
their explicit expressions are recorded in Appendix~\ref{app:perturbative-quantities}. the complete Noether charge therefore splits as
...
\subsection{charge matching}\label{subsec:charge-matching}
...
the explicit coefficient calculation is given in Appendix~\ref{app:perturbative-quantities}. it verifies both identities and therefore yields, on the constrained solution space,
