...
The gravitational density expands as
\begin{align}
  \sqrt{-g}(R+2)
  =\sqrt{-g^{(0)}}\left[
    \Lg^{(0)}
...
action $I^{(0)}[h,k,\varphi]$. The divergent and order-$\lambda^{-1}$ pieces
are background and boundary contributions in this perturbative expansion.
