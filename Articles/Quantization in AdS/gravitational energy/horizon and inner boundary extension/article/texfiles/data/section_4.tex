\section{Compact and anchored benchmarks}\label{sec:benchmarks}

\subsection{Compact BTZ calibration}\label{subsec:btz-benchmark}
...
\subsection{The AdS-Rindler double cutoff}\label{subsec:rindler-cutoff}
...
\subsection{Proper completion and regulator layers}\label{subsec:proper-completion}
...
\subsection{A propagating higher-dimensional local-Rindler diagnostic}\label{subsec:higher-dimensional-diagnostic}
