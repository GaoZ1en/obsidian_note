...
\subsection{Parameterized linked schedules}\label{subsec:parameterized-schedules}
...
\subsection{Explicit member and regulator independence}\label{subsec:regulator-independence}
