## Convention map and computational checks
...
### Symbolic and component verification

The following independent checks underlie the formulas used in the paper.

1. The Einstein--GHY descent, BTZ background curvature, wall extrinsic curvature, and outer charge normalization were evaluated in tensor components.
2. The fixed-surface Noether/area expansion was checked symbolically through second order with independent $h$ and $k$ coefficients.
3. The extremal-curve displacement, Jacobi equation, and endpoint term were checked in a parallel Fermi frame.
4. The compact $m=1$ canonical energy was obtained both from the second-order finite-action charge and from a direct Lee--Wald current integration.
5. The moving-wall momenta (\ref{eq:tangential-momentum})--(\ref{eq:normal-momentum}) were checked by directly differentiating the complete finite-wall BTZ action.
