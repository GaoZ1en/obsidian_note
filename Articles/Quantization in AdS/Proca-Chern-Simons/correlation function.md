...
$$\begin{align}
\sum ^{\infty}_{n,\bar{n}=0} f_{u,n,\bar{n}}^{\mu_{1}}(x_{1})f_{u,n,\bar{n}}^{*\mu_{2}}(x_{2}) & =\frac{1}{2\mu ^{2}}g^{\mu_{1}\nu_{2}}g^{\mu_{2}\nu_{2}}\partial _{\nu_{1}}\partial _{\nu_{2}}g_{\mu+2}(x_{1},x_{2}) \\
 ...
 & =\frac{1}{2\mu ^{2}}\partial ^{\mu_{1}}\partial ^{\mu_{2}}g_{\mu+2}(x_{1},x_{2})+\frac{i}{2\mu}\varepsilon ^{\mu_{1}\nu_{1}}_{~~~~~~\rho_{1}}(x_{1})g^{\rho_{1},\mu_{2}}(x_{1},x_{2})\partial _{\nu_{1}}g_{\mu+2}(x_{1},x_{2}) \\
...
$$\begin{align}
\sum ^{\infty}_{n,\bar{n}=0}f^{\mu_{1}}_{v,n,\bar{n}}(x_{1})f_{v,n,\bar{n}}^{*\mu_{2}}(x_{2}) & =\frac{1}{2\mu ^{2}}\partial ^{\mu_{1}}\partial ^{\mu_{2}}g_{\mu+2}(x_{1},x_{2})-\frac{i}{2\mu}\varepsilon ^{\mu_{2}\nu_{2}}_{~~~~~~\rho_{2}}(x_{2})\bar{g}^{\rho_{2},\mu_{1}}(x_{1},x_{2})\partial _{\nu_{2}}g_{\mu+2}(x_{1},x_{2}) \\
 & +\frac{1}{2}g^{\mu_{1},\mu_{2}}(x_{1},x_{2})g_{\mu+2}(x_{1},x_{2})
\end{align}$$
...
$$\begin{align}
\sum _{n,\bar{n}=0}^{\infty}f_{u,n,\bar{n}}^{\mu _{1}}f_{u,n,\bar{n}}^{*\mu _{2}} & =\frac{1}{2\mu _{+} ^{2}}\partial ^{\mu_{1}}\partial ^{\mu_{2}}g_{\mu _{+}+2}(x_{1},x_{2})+\frac{i}{2\mu _{+}}\varepsilon ^{\mu_{1}\nu_{1}}_{~~~~~~\rho_{1}}(x_{1})g^{\rho_{1},\mu_{2}}(x_{1},x_{2})\partial _{\nu_{1}}g_{\mu _{+}+2}(x_{1},x_{2}) \\
 & +\frac{1}{2}g^{\mu_{1},\mu_{2}}(x_{1},x_{2})g_{\mu _{+}+2}(x_{1},x_{2}) \\
\sum _{n,\bar{n}=0}^{\infty}f_{v,n,\bar{n}}^{\mu _{1}}f_{v,n,\bar{n}}^{*\mu _{2}} & = \frac{1}{2\mu _{-} ^{2}}\partial ^{\mu_{1}}\partial ^{\mu_{2}}g_{\mu _{-}+2}(x_{1},x_{2})-\frac{i}{2\mu _{-}}\varepsilon ^{\mu_{2}\nu_{2}}_{~~~~~~\rho_{2}}(x_{2})g^{\rho_{2},\mu_{1}}(x_{1},x_{2})\partial _{\nu_{2}}g_{\mu _{-}+2}(x_{1},x_{2}) \\
 & +\frac{1}{2}g^{\mu_{1},\mu_{2}}(x_{1},x_{2})g_{\mu _{-}+2}(x_{1},x_{2})
\end{align}$$
