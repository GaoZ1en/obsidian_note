\section{\texorpdfstring{1. The Proca-Chern-Simons theory in the global AdS$_3$ spacetime}{1. The Proca-Chern-Simons theory in the global AdS3 spacetime}}\label{sec:proca-cs-global-ads3}
...
\subsection{1.1 Spacetime background}\label{subsec:proca-cs-spacetime-background}
...
\subsection{1.2 The action and asymptotic boundary conditions}\label{subsec:proca-cs-action-boundary}
...
and the same falloffs hold for the corresponding variations. As shown in \hyperref[app:near-boundary-contributions]{Appendix~A}, these asymptotic conditions ensure that the action and the physical quantities entering the covariant phase space analysis remain finite. Therefore, the theory admits a well-defined variational principle without the need for additional boundary counterterms.
