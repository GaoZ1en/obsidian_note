...
$$\begin{align}
\zeta_{L} := \frac{\partial}{\partial t} - \frac{\partial}{\partial \phi} = 2 \xi_{0}, \qquad
...
$$\begin{align}
\mathcal{L}_{\zeta_{L}} A^{\mu} = - i (\omega + m) A^{\mu}, \qquad \mathcal{L}_{\zeta_{R}} A^{\mu} = - i (\omega - m) A^{\mu}.
\end{align}$$

Applying the bilinear identity with $(A_{1},A_{2}) = (A, A^{*})$ gives

$$\begin{align}
i (\omega + m) \Omega[A, A^{*}] = H_{\zeta_{L}}^{(2)}[A, A^{*}], \qquad
...
$$\begin{align}
H_{\zeta_{L}}^{(2)}[A, A^{*}] & = \int_{0}^{\infty} \mathrm{d}r \int_{0}^{2 \pi} \mathrm{d}\phi \Bigg[ r \left| F_{tr} + F_{r \phi} \right|^{2} + \frac{1}{r} \left| F_{r \phi} \right|^{2} + \frac{1}{r(1+r^{2})} \left| F_{t \phi} \right|^{2} \\
& \qquad \qquad + \mu^{2} \frac{r}{1+r^{2}} \left| A_{t} - A_{\phi} \right|^{2} + \mu^{2} r(1+r^{2}) \left| A_{r} \right|^{2} + \mu^{2} \frac{1}{r(1+r^{2})} \left| A_{\phi} \right|^{2}
\Bigg],
\end{align}$$
...
$$\begin{align}
H_{\zeta_{R}}^{(2)}[A, A^{*}] & = \int_{0}^{\infty} \mathrm{d}r \int_{0}^{2 \pi} \mathrm{d}\phi \Bigg[ r \left| F_{tr} - F_{r \phi} \right|^{2} + \frac{1}{r} \left| F_{r \phi} \right|^{2} + \frac{1}{r(1+r^{2})} \left| F_{t \phi} \right|^{2} \\
& \qquad \qquad + \mu^{2} \frac{r}{1+r^{2}} \left| A_{t} + A_{\phi} \right|^{2} + \mu^{2} r(1+r^{2}) \left| A_{r} \right|^{2} + \mu^{2} \frac{1}{r(1+r^{2})} \left| A_{\phi} \right|^{2}
\Bigg].
\end{align}$$
...
$$\begin{align}
\mathcal{L}_{\xi_{0}} A_{\pm,0}^{\mu} = - i h_{\pm} A_{\pm,0}^{\mu}, \qquad \mathcal{L}_{\bar{\xi}_{0}} A_{\pm,0}^{\mu} = - i \bar{h}_{\pm} A_{\pm,0}^{\mu}.
\end{align}$$

Using

$$\begin{align}
\frac{\partial}{\partial t} = \xi_{0} + \bar{\xi}_{0}, \qquad \frac{\partial}{\partial \phi} = - \xi_{0} + \bar{\xi}_{0},
\end{align}$$

one reads off

$$\begin{align}
\omega = h_{\pm} + \bar{h}_{\pm}, \qquad
m = h_{\pm} - \bar{h}_{\pm}.
\end{align}$$
...
$$\begin{align}
\left( h_{+}, \bar{h}_{+} \right) = \left( \frac{\mu_{+}}{2}, 1 + \frac{\mu_{+}}{2} \right), \qquad \left( h_{+}, \bar{h}_{+} \right) = \left( 1 - \frac{\mu_{+}}{2}, - \frac{\mu_{+}}{2} \right).
\end{align}$$

For the $-$ branch, the two candidate pairs are

$$\begin{align}
\left( h_{-}, \bar{h}_{-} \right) = \left( 1 + \frac{\mu_{-}}{2}, \frac{\mu_{-}}{2} \right), \qquad \left( h_{-}, \bar{h}_{-} \right) = \left( - \frac{\mu_{-}}{2}, 1 - \frac{\mu_{-}}{2} \right).
\end{align}$$
