...
$$
\langle\phi^2\rangle_{\rm ren}^{\mathbb H^3}
=-\frac{\Delta-1}{4\pi\ell}.
$$
...
\left[
1+\frac{2r^2}{r_+^2}
\sinh^2\left(\frac{\pi n r_+}{\ell}\right)
\right].
$$
...
$$
\boxed{
\langle\phi^2(r)\rangle_{\rm ren}^{\rm HHI}
=-\frac{\Delta-1}{4\pi\ell}
+c_{\rm scheme}
+\mathcal I_\Delta(r)
},
...
$$
\mathcal I_2(r_+)
=1.1100632908032619\times10^{-6},
$$

and minimal geodesic subtraction gives

$$
\langle\phi^2(r_+)\rangle_{\rm ren}
=-0.07957636148265686.
$$
...
g_{km}(z,y)\mathcal I_2(y)g_{km}(y,z').
$$
