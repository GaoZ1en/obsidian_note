...
Research notes on quantization and perturbative field theory in AdS, including AdS3 gauge and gravity systems, AdS4 linearized gravity, scalar thermodynamics, covariant phase space, pAQFT, and gravitational energy.
...
| `gluing/` | CPS and Hamiltonian gluing of Dirichlet/Neumann pieces into periodic theories, including nonuniform flat-circle regulators, a global-AdS2 scalar benchmark, finite-coupling angular-wedge gluing, and AdS-Rindler Cauchy-data reconstruction of a global-AdS3 scalar and its charges |
...
1. Move to `Proca/` for the main massive-vector quantization calculations
