...
\[
\phi=\sum_{a,b\ge0}g_3^a g_4^b\,\phi_{a,b},
\qquad
\phi_{0,0}=\phi_0.
\]
...
\[
\phi_{a,b}(x)
=\int d^4y\,G_R(x-y)\,S_{a,b}(y),
\]

其中 \(S_{a,b}\) 是上式右边。固定初始时刻 \(t_0\) 时，我们取

\[
\phi_{a,b}|_{\Sigma_{t_0}}=0,\qquad
...
\[
\phi_{1,0}(x)
=\frac12\int d^4y\,G_R(x-y)\phi_0(y)^2.
\]

\[
\phi_{0,1}(x)
=\frac1{3!}\int d^4y\,G_R(x-y)\phi_0(y)^3.
\]

\[
K\phi_{2,0}=\phi_0\phi_{1,0},
\qquad
\phi_{2,0}=G_R(\phi_0\phi_{1,0}).
\]

\[
K\phi_{1,1}
=\phi_0\phi_{0,1}
+\frac12\phi_0^2\phi_{1,0}.
\]

\[
K\phi_{0,2}
=\frac12\phi_0^2\phi_{0,1}.
\]
...
\[
\phi_0(x)=
\int\frac{d^3\mathbf k}{(2\pi)^3\sqrt{2E_{\mathbf k}}}
\left[
...
\[
\widetilde{\phi}_{a,b}(p)
=\widetilde G_R(p)\,\widetilde S_{a,b}(p),
\]
...
\widetilde\phi_{a_1,b_1}(q)
\widetilde\phi_{a_2,b_2}(p-q)
\]
...
\frac1{3!}
\sum_{\substack{a_1+a_2+a_3=a\\ b_1+b_2+b_3=b-1}}
\int\frac{d^4q\,d^4r}{(2\pi)^8}
\widetilde\phi_{a_1,b_1}(q)
\widetilde\phi_{a_2,b_2}(r)
\widetilde\phi_{a_3,b_3}(p-q-r).
\]
...
J(P)=\widetilde G(P)
\left[
\frac{g_3}{2}\sum_{P=A\sqcup B}J(A)J(B)
+\frac{g_4}{3!}\sum_{P=A\sqcup B\sqcup C}J(A)J(B)J(C)
\right],
\]
...
\[
\delta L
=E(\phi)\delta\phi\,d^4x+\partial_\mu\Theta^\mu\,d^4x,
\]
...
\[
\omega^\mu(\delta_1\phi,\delta_2\phi)
=\delta_1\phi\,\partial^\mu\delta_2\phi
-\delta_2\phi\,\partial^\mu\delta_1\phi.
\]
...
\Omega_{\rm eff}
=\int_{\Sigma_t}d^3x\,
\delta\dot\phi(\phi_0)\wedge\delta\phi(\phi_0).
\]
...
4. 所以
   \[
   \Omega_{\rm eff}|_{\Sigma_{t_0}}
   =\int_{\Sigma_{t_0}}d^3x\,
   \delta\dot\phi_0\wedge\delta\phi_0
   =\Omega_0.
   \]
...
\[
\Omega_0
=i\int\frac{d^3\mathbf k}{(2\pi)^3}
\delta a^*(\mathbf k)\wedge\delta a(\mathbf k)
\]
...
\[
H_3=\int_{\Sigma_{t_0}}d^3x\,\frac1{3!}\phi_0^3,
\qquad
H_4=\int_{\Sigma_{t_0}}d^3x\,\frac1{4!}\phi_0^4.
\]
...
\[
\text{solution map }p_g:\mathcal S_0\to\mathcal S_g,
\qquad
...
K\phi_{a,b}
=
\frac12\sum\phi_{a_1,b_1}\phi_{a_2,b_2}
+\frac1{3!}\sum\phi_{a_1,b_1}\phi_{a_2,b_2}\phi_{a_3,b_3}.
\]
...
\[
\Omega_{\rm eff}
=\int_{\Sigma}d^3x\,\delta\dot\phi\wedge\delta\phi
=\Omega_0
\]
