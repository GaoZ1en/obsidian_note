...
**Lemma 2.5 (Limit curve)**. A sequence of future directed causal curves contained in a common compact set with uniformly bounded parameter length admits a uniformly convergent (on compact subintervals) causal subsequence.

**Lemma 2.6 (Achronal boundary generation)**. The boundary of $I^+(S)$ of an achronal set $S$ is generated by future inextendible null geodesics from $S$ without conjugate points before leaving the boundary.

**Lemma 2.7 (Domain of dependence closure)**. For achronal $\Sigma$, $D^\pm(\Sigma)$ are closed; the Cauchy horizon $H^+(\Sigma)=\overline{D^+(\Sigma)}\setminus I^-(D^+(\Sigma))$ is (piecewise) null, generated by null geodesics without past endpoints in $D^+(\Sigma)$.

**Lemma 2.8 (Causal simplicity criteria)**. Equivalent: (i) $J^\pm(p)$ closed $\forall p$; (ii) $\overline{I^\pm(p)}=J^\pm(p)$; (iii) $J^+\subset M\times M$ closed. Global hyperbolicity implies causal simplicity.

**Lemma 2.9 (Strong causality / causal convexity)**. Strong causality at $p$ iff every neighborhood $U$ of $p$ contains $V\subset U$ such that any causal curve with endpoints in $V$ lies in $U$.

*Usage*. Lemmas 2.5–2.9 are invoked in proofs of Geroch (compactness via limit curves), Penrose (generator structure), and Hawking (existence of maximizing geodesics after global hyperbolicity is established).
...
1. Relations: $I^\pm, J^\pm$, closure and transitivity (Prop 2.4).
...
Definitions: 1.1 Spacetime; 1.2 Causal types; 1.3 Light cone; 1.4 Causal curve; 2.1 Chronological/causal relation; 2.2 Futures/pasts; 2.3 Domain of dependence; 3.2 Non‑totally vicious; 3.3 Chronological; 3.4 Causal; 3.5 Distinguishing; 3.6 Strongly causal; 3.7 Stably causal; 3.8 Global hyperbolicity; 3.9 Cauchy surface; 4.1 Event horizon; 4.2 Trapped/marginal surface; 4.3 Killing horizon; 4.4 Isolated horizon; 4.5 FOTH; 4.6 Dynamical horizon; 4.7 MOTT; 5.1 Conformal rescaling; 5.2 Conformal compactification; 5.3 Asymptotic simplicity; 5.4 Asymptotic flatness; 5.5 Strong asymptotic predictability; 6.1 Geodesic completeness; 6.2 Singularity; 6.3 Conjugate points; 6.8 Królak strong curvature; 6.9 Tipler strong curvature.

Core Equations: (1.1) line element; (1.2) causal types; (2.1) causal sets; (2.2) domain of dependence; (3.2) auxiliary time function; (3.3) smoothed time function; (4.1) null expansion; (5.1) null geodesic reparametrisation under conformal change; (5.2) Ricci / scalar curvature transformation; (5.3) Weyl invariance; (5.4) expansion transformation; (6.1)-(6.2) Raychaudhuri; (6.3)-(6.5) decomposition steps; (6.6)-(6.7) focusing inequalities.

Lemmas/Propositions/Theorems: Prop 2.4 causal properties; Lem 2.5 limit curve; Lem 2.6 achronal boundary; Lem 2.7 domain of dependence; Lem 2.8 causal simplicity; Lem 2.9 strong causality local form; Prop 3.4 chronology/time function; Lem 3.5 causal⇒chronological; Prop 3.6 distinguishing⇒causal; Thm 3.7 stable causality; Thm 3.8 Geroch; Thm 3.9 Bernal–Sánchez; Lem 3.10 volume time; Lem 3.11 maximizing geodesic; Lem 6.4 focusing; Thm 6.5 Hawking; Thm 6.6 Penrose; Thm 6.7 Hawking–Penrose.
