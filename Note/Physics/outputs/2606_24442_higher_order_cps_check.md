...
4. **发现 2606.24442 v2 的一个符号不一致**。其精确解展示式中低能分支 \(y\) 的号与 EOM、\(\lambda=0\) 极限、后续 \(\pi_x,\pi_y\) 公式和 Sec. 4.4 的 CPS commutator 不一致。正确低能分支应取
   ...
   \left(a e^{-i f_1t}-a^\dagger e^{i f_1t}\right).
   \]
   因此低能
   \[
...
\[
q:=\lambda\omega,\qquad s:=\omega t,
\qquad d:=\sqrt{1+4q}.
\]
...
\[
x=\sum_{n\ge0}q^n X_n,\qquad
y=\sum_{n\ge0}q^n Y_n.
\]
...
\binom{X_n(s)}{Y_n(s)}
=
U_0(s)\binom{h^x_n}{h^y_n}
+\int_0^s du\,
U_0(s-u)
\binom{Y_{n-1}''(u)}{-X_{n-1}''(u)}.
\]
...
\[
c(q)=1-q+\frac52q^2-\frac{15}{2}q^3+\frac{195}{8}q^4
-\frac{663}{8}q^5+\frac{4641}{16}q^6+\cdots,
\]
...
\[
x=A(q,s)x_0+B(q,s)y_0,\qquad
y=-B(q,s)x_0+A(q,s)y_0,
\]
...
A(q,s)=
1-q
+\left(\frac52-\frac{s^2}{2}\right)q^2
+\frac52(-3+s^2)q^3
+\frac{585-246s^2+s^4}{24}q^4
+O(q^5),
\]
...
\[
x=(1-\lambda\omega+\tfrac52\lambda^2\omega^2)x_0
-\lambda\omega^2t\,y_0
+\lambda^2\left(3\omega^3t\,y_0-\frac12\omega^4t^2x_0\right)
+O(\lambda^3),
\]

\[
y=(1-\lambda\omega+\tfrac52\lambda^2\omega^2)y_0
+\lambda\omega^2t\,x_0
+\lambda^2\left(-3\omega^3t\,x_0-\frac12\omega^4t^2y_0\right)
+O(\lambda^3).
\]
...
x^{(3)}=
\lambda^3\left[
\left(-\frac{15}{2}\omega^3+\frac52\omega^5t^2\right)x_0
+\left(-\frac{19}{2}\omega^4t+\frac16\omega^6t^3\right)y_0
\right],
\]
...
y^{(3)}=
\lambda^3\left[
-\left(-\frac{19}{2}\omega^4t+\frac16\omega^6t^3\right)x_0
+\left(-\frac{15}{2}\omega^3+\frac52\omega^5t^2\right)y_0
\right].
\]
...
x^{(4)}=
\lambda^4\left[
\left(\frac{195}{8}\omega^4-\frac{41}{4}\omega^6t^2+\frac1{24}\omega^8t^4\right)x_0
+\left(\frac{63}{2}\omega^5t-\frac76\omega^7t^3\right)y_0
\right],
\]
...
y^{(4)}=
\lambda^4\left[
-\left(\frac{63}{2}\omega^5t-\frac76\omega^7t^3\right)x_0
+\left(\frac{195}{8}\omega^4-\frac{41}{4}\omega^6t^2+\frac1{24}\omega^8t^4\right)y_0
\right].
\]
...
\[
\Omega
=-\delta x\wedge\delta y
+\lambda(\delta\dot x\wedge\delta x+\delta\dot y\wedge\delta y).
\]

对低能闭式解，

\[
\partial_s x=r y,\qquad
\partial_s y=-r x.
\]
...
\[
\Omega_{\rm low}
=-(1+2qr)c^2\,\delta x_0\wedge\delta y_0.
\]
...
\[
H_{\rm low}
=\frac{\omega}{2}c^2(1+qr^2)(x_0^2+y_0^2).
\]
...
\[
f_1=\omega\left[
1-q+2q^2-5q^3+14q^4-42q^5+132q^6-\cdots
\right].
\]
...
E_n=
\omega\left[
1-\lambda\omega+2\lambda^2\omega^2
-5\lambda^3\omega^3+14\lambda^4\omega^4
-42\lambda^5\omega^5+\cdots
\right]\left(n+\frac12\right).
\]
...
\[
\Omega_{\rm low}=-i\delta a\wedge\delta a^\dagger,
\qquad [a,a^\dagger]=1,
\]
...
\[
\frac1d
=1-2q+6q^2-20q^3+70q^4-252q^5+924q^6+\cdots.
\]
...
[verify_2606_higher_order.wl](/Users/koishi/Documents/Codex/2026-07-09/diagrammatics-ode-pde-feynman-rules-qcd/outputs/verify_2606_higher_order.wl)
...
- 本目录上一份 note: [diagrammatic_perturbative_solutions_cps_note.md](/Users/koishi/Documents/Codex/2026-07-09/diagrammatics-ode-pde-feynman-rules-qcd/outputs/diagrammatic_perturbative_solutions_cps_note.md)
