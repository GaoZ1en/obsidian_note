...
B_{m} & =\sin mt\sin m\phi \partial_{t}-\cos mt\cos m\phi \partial_{\phi} \\
C_{m} & =\sin mt\cos m\phi \partial_{t}+\cos mt\sin m\phi \partial_{\phi} \\
D_{m} & =\cos mt\sin m\phi \partial_{t}+\sin mt\cos m\phi \partial_{\phi}
\end{align}
$$
