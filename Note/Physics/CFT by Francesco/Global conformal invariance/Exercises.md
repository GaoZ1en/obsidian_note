...
1. 
	...
	2. show that there are only two independent cross-ratios of the form (4.23) can be built out of four point, except in dimension two, where the two cross-ratios are related.
...
2. show that the two-point function $\displaystyle{\Gamma_{2}(X)}$ of a scale-invariant theory is of the form
...
3. in dimension two, show that the two-point function in coordinate space must accordingly be
