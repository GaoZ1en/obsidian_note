...
2. $\displaystyle{R}$, Einstein-Hilbert action
...
2. $\displaystyle{\partial_{\nu}A^{\mu \nu}=0}$
3. $\displaystyle{A^{\mu \nu}=A^{\nu \mu}}$
4. second-derivative of the metric $\displaystyle{g_{\alpha \beta}}$ is linear.
...
2. introduce higher-derivative terms
3. construct theory in non-4-dimension
4. give up locality (not mainstream, but we must understand it to quantize gravity)
5. not conservation of stress-energy tensor