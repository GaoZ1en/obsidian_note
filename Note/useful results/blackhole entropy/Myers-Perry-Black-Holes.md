...
1. $\frac{\partial^2 M}{\partial S^2} > 0$ (convexity of mass)
1. $\det(\partial^2 M/\partial X_i \partial X_j) > 0$ where $X_i = \{S, J_1, \ldots, J_N\}$
...
1. **Higher-dimensional entropy**: $S = \frac{\Omega_{d-2}}{4Gr_H^{d-3}}\prod_i(r_H^2 + a_i^2)$
1. **Multiple angular velocities**: $\Omega_H^i = \frac{a_i}{r_H^2 + a_i^2}$
1. **Dimensional scaling**: All quantities scale appropriately with dimension
