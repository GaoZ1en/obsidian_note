...
1. **Modified potential**: Electric potential includes dilaton-dependent factor
1. **No inner horizon thermodynamics**: Inner horizon is singular due to dilaton divergence
1. **String theory connection**: $a = 1$ case emerges from low-energy string theory
...
1. **D-brane constructions**: Bound states of D-branes produce dilaton black holes
1. **AdS/CFT holography**: Dilaton black holes as gravity duals
1. **Black hole microstate counting**: Statistical entropy calculations

### Thermodynamic Stability

**Stability analysis** shows:
1. **Heat capacity**: $C = T_H \frac{\partial S}{\partial T_H}$ can be negative (unstable)
1. **Phase transitions**: Between dilaton-dominated and Einstein gravity regimes
1. **Evaporation endpoint**: Possible stable remnants in some models
1. **Information preservation**: Modified Hawking radiation spectrum

### Observational Signatures

Potential observational differences:
1. **Gravitational waves**: Modified waveforms from dilaton hair
1. **Accretion dynamics**: Altered electromagnetic coupling affects accretion
1. **Shadow imaging**: Modified photon sphere structure
1. **Gravitational lensing**: Dilaton field affects light deflection
...
1. **4D GHS**: $\delta M = T_H \delta S + \Phi_H \delta Q$ with modified entropy and potential
1. **Higher-D**: Extended first law including dilaton chemical potential
1. **Quantum corrections**: Modified temperature and entropy from back-reaction
