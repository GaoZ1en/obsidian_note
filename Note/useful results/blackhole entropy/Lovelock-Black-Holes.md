...
1. **String theory**: Natural emergence from α' corrections to Einstein gravity
1. **Critical dimension**: D=10,11 superstring/M-theory compactifications
1. **Holography**: AdS/CFT with higher-curvature bulk theories
...
1. **Convexity**: $\frac{\partial^2 M}{\partial S^2} > 0$
1. **Response functions**: All thermodynamic response functions well-behaved
...
1. **Heat capacity**: $C = T_H \frac{\partial S}{\partial T_H}$
1. **Critical points**: Locations where $\frac{\partial T_H}{\partial S} = 0$
...
1. **Modified Entropy**: Jacobson-Myers formula with curvature corrections
1. **Rich Phase Structure**: Multiple critical points and phase transitions
1. **String Theory Connection**: Natural emergence from α' corrections
