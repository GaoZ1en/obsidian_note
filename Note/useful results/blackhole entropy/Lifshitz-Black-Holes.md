...
2. **Non-Fermi liquids**: Unconventional metallic phases
3. **Quantum Hall states**: Anisotropic scaling in 2+1 dimensions
4. **Superconductors**: Holographic models of strange metals
...
2. **Non-minimal coupling** of matter fields
3. **Quantum corrections** from anisotropic scaling
...
2. **Chemical term**: $\mu \delta Q$ - work done by electric field
3. **Scaling term**: $\mathcal{T}_z \delta z$ - work associated with changing anisotropy
...
3. **Charge-dependent transitions**: Related to the chemical potential behavior
...
2. **Anisotropic Scaling**: Temperature and entropy scale differently than in AdS
3. **Chemical Potential**: Natural emergence from gauge field boundary conditions
4. **Thermodynamic Instability**: Negative heat capacities in certain parameter ranges
