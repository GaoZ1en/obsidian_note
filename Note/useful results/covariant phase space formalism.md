...
although there is no dynamical degree of freedom in the bulk, the theory has non-trivial phase space structure due to the boundary term. consider a gauge transformation generated by $\displaystyle{\varepsilon ^{a}(x)}$
