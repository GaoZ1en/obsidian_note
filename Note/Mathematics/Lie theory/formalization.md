...
1. group. a set $\displaystyle{G}$ with a product $\displaystyle{\cdot:G\times G\to G}$ that satisfies
	...
	1. unity: $\displaystyle{\exists e\in G,\text{ s.t. }\forall g\in G, e\cdot g=g\cdot e=g}$
	1. inverses: $\displaystyle{\forall g\in G,\exists g^{-1}\in G\text{ s.t. }g\cdot g^{-1}=g^{-1}\cdot g=e}$
1. ring. a group $\displaystyle{R}$ with a product $\displaystyle{\cdot:R\times R\to R}$ and an addition $\displaystyle{+:R\times R\to R}$ that satisfy
	1. $\displaystyle{(R,+)}$ is an Abelian group
	1. associative for $\displaystyle{\cdot}$
	1. distributative: $\displaystyle{\forall x,y,z\in R,\text{ s.t. }x\cdot(y+z)=x\cdot y+x\cdot z}$
1. field. a ring $\displaystyle{F}$ with a product $\displaystyle{\cdot:F\times F\to F}$ and an addition $\displaystyle{+:R\times R\to R}$ that satisfy
	1. $\displaystyle{(F,\cdot,+)}$ is a ring
	1. $\displaystyle{\cdot}$ is commutative
	1. $\displaystyle{\forall x \in F-\left\{0\right\},\exists x^{-1}\in F\text{ s.t. }x\cdot x^{-1}=x^{-1}\cdot x=e}$
1. vector space. a vector space $\displaystyle{V}$ over a field $\displaystyle{F}$ with an addition $\displaystyle{+:V\times V\to V}$ and a multiplication by elements of $\displaystyle{F}$ that satisfy
	1. (eight properties)
1. algebra. an algebra $\displaystyle{A}$ is a vector space endowed with an binary operation $\displaystyle{\diamond:A\times A\to A}$ that satisfies
	1. $\displaystyle{(x+y)\diamond z=x\diamond y+y\diamond z, x\diamond(y\diamond z)=x\diamond y+x\diamond z}$
	1. $\displaystyle{(\xi x)\diamond(\eta y)=\xi \eta(x\diamond y)}$
...
1. Jabobi identity: $\displaystyle{\forall x,y,z\in \mathfrak{g}, [x,[y,z]]+[y,[z,x]]+[z,[x,y]]=0}$
