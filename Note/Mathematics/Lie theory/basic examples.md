...
1. these finite-dimensional irreps form a complete orthogonal system for $L^2(G)$
1. every continuous representation can be decomposed into finite-dimensional irreps
